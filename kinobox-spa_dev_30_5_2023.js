...
//        h4.setAttribute('id','adform_halfpage4');
//        document.body.appendChild(h4);
    ...
    //            }
            ...
            //}, 1000);
        } //konec spaElScriptAdformtag onload
 
        setTimeout(function(){
            var selection = document.querySelector('#adform_halfpage4') !== null;
            if (selection) {
                //document.querySelector('#adform_halfpage4').remove();
            } 
        }, 4000);
      }
