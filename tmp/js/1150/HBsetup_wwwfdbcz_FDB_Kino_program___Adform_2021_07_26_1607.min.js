...
var bidderFloor = {"cpex-tt": 3,"criteo-im": 3,"adform-im-tt": 3,"cpex-nt": 3,"adform-im-nt": 3,"r2b2": 3,"mgid": 3,"appnexus": 3,"PubMatic": 3,"Teads": 3
};
var webFloor = 1.00;
var webResponzivitaRange ='branding:1200::|mobil::1199:|desktop:1200::|all:1:9999:';
var webBidders ='cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,PubMatic,Teads,adform-im-tt_id_2,mgid,r2b2_id_2';    
...
var bidderAlias = {"cpex-tt":"rubicon","criteo-im":"criteo","adform-im-tt":"adform","cpex-nt":"rubicon","adform-im-nt":"adform","r2b2":"r2b2","mgid":"mgid","appnexus":"appnexus","PubMatic":"pubmatic","Teads":"teads"};
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            ...
            code:'adform_leaderboard4',
                mediaTypes: {
                   banner: {sizes: [
               [970,210],[970,100],[970,90],[910,90],[728,90],[970,250],[980,250],[980,200],[745,200],[745,100]
                   ]}
                },"labelAny": ["all"],"bids": [
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            ...
            code:'adform_leaderboard3',
                mediaTypes: {
                   banner: {sizes: [
               [970,210],[970,100],[970,90],[910,90],[728,90],[970,250],[980,250],[980,200],[745,100],[745,200]
                   ]}
                },"labelAny": ["all"],"bids": [
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            ...
            code:'adform_leaderboard',
                mediaTypes: {
                   banner: {sizes: [
               [970,210],[970,100],[970,90],[910,90],[728,90],[970,250],[980,250],[745,100],[745,200],[980,200]
                   ]}
                },"labelAny": ["mobil"],"bids": [
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            ...
            code:'adform_leaderboard',
                mediaTypes: {
                   banner: {sizes: [
               [2000,1400],[970,210],[970,100],[970,90],[910,90],[728,90],[970,250],[980,250],[745,100],[745,200],[980,200]
                   ]}
