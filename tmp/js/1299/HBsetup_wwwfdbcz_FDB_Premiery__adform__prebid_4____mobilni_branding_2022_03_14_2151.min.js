...
var bidderFloor = {"cpex-tt": 3,"criteo-im": 3,"adform-im-tt": 3,"cpex-nt": 3,"adform-im-nt": 3,"r2b2": 3,"mgid": 3,"appnexus": 3,"stroeerCore": 5,"adform-omd": 3,"PubMatic": 3,"ix": 3
};
var webFloor = 1.00;
var webResponzivitaRange ='branding:1200::|mobil::1199:|desktop:1200::|all:1:9999:';
var webBidders ='cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,stroeerCore,PubMatic,ix,adform-omd,mgid,r2b2_id_2';    
var placementFloor = {"adformleaderboard4": 0.00,"adformleaderboard3": 0.00,"adformleaderboard": 0.00,"adformleaderboard": 0.00,"adformMobilniBranding": 1.00,
};
var bidderAlias = {"cpex-tt":"rubicon","criteo-im":"criteo","adform-im-tt":"adform","cpex-nt":"rubicon","adform-im-nt":"adform","r2b2":"r2b2","mgid":"mgid","appnexus":"appnexus","stroeerCore":"stroeerCore","adform-omd":"adform","PubMatic":"pubmatic","ix":"ix"};
var tierAlias = {"726517":"adform_leaderboard4","726518":"adform_leaderboard3","726516":"adform_leaderboard","802926":"adform_leaderboard","726533":"adform_mobilnibranding",
};
var responzivita = {"adform_leaderboard4":"all","adform_leaderboard3":"all","adform_leaderboard":"mobil","adform_leaderboard":"desktop","adformMobilniBranding":"mobil",
};    
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 9999))){
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            ...
            document.querySelector("#adform_leaderboard4").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 1');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_leaderboard4").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 1');
            }
        }
    }else{ 
    ...
    if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 9999))){
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            ...
            document.querySelector("#adform_leaderboard3").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 1');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_leaderboard3").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 1');
            }
        }
    }else{ 
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1299&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
...
//      var check726517 = document.querySelector("#adform_leaderboard4") !== null;

//      if (check726517) {
//          document.querySelector("#adform_leaderboard4").innerHTML = '';
//      }
      }
...
//      var check726518 = document.querySelector("#adform_leaderboard3") !== null;

//      if (check726518) {
//          document.querySelector("#adform_leaderboard3").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
//  Web Variableexclude#@##@#
...
//      var check726516 = document.querySelector("#adform_leaderboard") !== null;
...
//      var check802926 = document.querySelector("#adform_leaderboard") !== null;
  ...
  if((pbjs.WEURON_WindowWidth <= 1199)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable.adformMobilniBranding = '726533';
        }else{
        }    
        pbjs.adUnits.push(    
        {
            id: 'wwwfdbcz-1-1299-911225',
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "fdb/Mobilnibranding_726533",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions.adformMobilniBranding = '726533';
  
      }else{
//      var check726533 = document.querySelector("#adformMobilniBranding") !== null;
