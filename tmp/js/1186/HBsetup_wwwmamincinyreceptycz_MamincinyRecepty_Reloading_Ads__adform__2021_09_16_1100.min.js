 ...
 * Last update: 16.09.2021  11:00
 * Generated for WebSite: [https://www.mamincinyrecepty.cz] 
 * Custom ticket name: [MamincinyRecepty Reloading Ads (adform)]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1186]
 * User ID: [1]    
...
var webBidders = 'cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,stroeerCore';    
var placementFloor = { 
    "adformleaderboard": 0.00,
    "adformsquarem": 0.00,
    "adformskyscraper": 0.00,
    "adformskyscraper2": 0.00,
};
var bidderAlias = { 
    "cpex-tt": "rubicon",
    "criteo-im": "criteo",
...
var tierAlias = { 
    "751427": "adform_leaderboard",
    "751430": "adform_squarem",
    "751417": "adform_skyscraper",
    "751423": "adform_skyscraper2",
};
var responzivita = { 
    "adform_leaderboard": "desktop",
    "adform_squarem": "mobil,tablet",
    "adform_skyscraper": "All",
    "adform_skyscraper2": "desktop",
};    
...
var checkReloadingAdsRestriction; 
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 2' + '' );
    ...
    if (checkReloadingAdsRestriction < 0) {
        ...
        console.log('ID: adform_leaderboard / MID:751427 / DIV ID found: ' + nonResponsiveLeaveBlank);
    ...
    console.log('adform_squarem : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 2' + '' );
    checkReloadingAdsRestriction = 1000 - (2 - imHbReloadingAds);
    ...
    if (checkReloadingAdsRestriction < 0) {
        ...
        console.log('ID: adform_squarem / MID:751430 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
    ...
    console.log('adform_skyscraper : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 2' + '' );
    checkReloadingAdsRestriction = 1000 - (2 - imHbReloadingAds);
    
    console.log('imHbReloadingAds:: '+imHbReloadingAds);
    console.log('imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction); 
    if (checkReloadingAdsRestriction < 0) {
        console.log('adform_skyscraper : REMOVE imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);     
        nonResponsiveLeaveBlank = document.querySelector("#adform_skyscraper") !== null;
        console.log('ID: adform_skyscraper / MID:751417 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
            document.querySelector("#adform_skyscraper").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('adform_skyscraper2 : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 2' + '' );
    checkReloadingAdsRestriction = 1000 - (2 - imHbReloadingAds);
    
    console.log('imHbReloadingAds:: '+imHbReloadingAds);
    console.log('imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction); 
    if (checkReloadingAdsRestriction < 0) {
        console.log('adform_skyscraper2 : REMOVE imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);     
        nonResponsiveLeaveBlank = document.querySelector("#adform_skyscraper2") !== null;
        console.log('ID: adform_skyscraper2 / MID:751423 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
            document.querySelector("#adform_skyscraper2").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1186&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_leaderboard / hbPlacement751427: ' + hbPlacement);
        if (hbPlacement) {
        ...
        console.log('Responzivita = TRUE >> Placement / MID: adform_leaderboard / 751427  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwmamincinyreceptycz-1-1186-910350',
            code: 'adform_leaderboard',
                mediaTypes: {
                   banner: {sizes: [
               [970,250],[970,210],[728,90],[970,200],[900,200],[745,200],[745,100]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "9267b2d9-12e6-4e63-a12a-bb7bb4eaaaef",    
                        }                
                }
              ]
            }
        ...
        console.log('Responzivita = FALSE >> Placement / MID: adform_leaderboard / 751427  (' + pbjs.WEURON_WindowWidth + ')');
//      var check751427 = document.querySelector("#adform_leaderboard") !== null;
//      console.log('ID: adform_leaderboard / check751427: ' + check751427);
//      if (check751427) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 767) || ((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_squarem / hbPlacement751430: ' + hbPlacement);
        if (hbPlacement) {
        ...
        console.log('Responzivita = TRUE >> Placement / MID: adform_squarem / 751430  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwmamincinyreceptycz-1-1186-910351',
            code: 'adform_squarem',
                mediaTypes: {
                   banner: {sizes: [
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "f774139e-3093-4671-a176-c7f4a7178ef8",    
                        }                
                }
              ]
            }
        ...
        console.log('Responzivita = FALSE >> Placement / MID: adform_squarem / 751430  (' + pbjs.WEURON_WindowWidth + ')');
//      var check751430 = document.querySelector("#adform_squarem") !== null;
//      console.log('ID: adform_squarem / check751430: ' + check751430);
//      if (check751430) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 9999))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_skyscraper / hbPlacement751417: ' + hbPlacement);
        if (hbPlacement) {
        ...
        console.log('Responzivita = TRUE >> Placement / MID: adform_skyscraper / 751417  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwmamincinyreceptycz-1-1186-910352',
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "72b9b0a4-1a40-4d4e-ab1c-561dff011c4a",    
                        }                
                }
              ]
            }
        ...
        console.log('Responzivita = FALSE >> Placement / MID: adform_skyscraper / 751417  (' + pbjs.WEURON_WindowWidth + ')');
//      var check751417 = document.querySelector("#adform_skyscraper") !== null;
//      console.log('ID: adform_skyscraper / check751417: ' + check751417);
//      if (check751417) {
//          document.querySelector("#adform_skyscraper").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_skyscraper2 / hbPlacement751423: ' + hbPlacement);
        if (hbPlacement) {
        ...
        console.log('Responzivita = TRUE >> Placement / MID: adform_skyscraper2 / 751423  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwmamincinyreceptycz-1-1186-910353',
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "f0c2771f-db49-4bae-b213-db42d762188f",    
                        }                
                }
              ]
            }
        ...
        console.log('Responzivita = FALSE >> Placement / MID: adform_skyscraper2 / 751423  (' + pbjs.WEURON_WindowWidth + ')');
//      var check751423 = document.querySelector("#adform_skyscraper2") !== null;
//      console.log('ID: adform_skyscraper2 / check751423: ' + check751423);
//      if (check751423) {
//          document.querySelector("#adform_skyscraper2").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
