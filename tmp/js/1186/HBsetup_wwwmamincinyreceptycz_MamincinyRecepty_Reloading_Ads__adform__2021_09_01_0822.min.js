...
pbjs.adUnits = [];
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_leaderboard").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=751427"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
  ...
  if((pbjs.WEURON_WindowWidth <= 767) || ((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_squarem").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=751430"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 9999))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_skyscraper").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=751417"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_skyscraper2").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=751423"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
