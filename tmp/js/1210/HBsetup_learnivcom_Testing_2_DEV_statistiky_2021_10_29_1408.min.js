 ...
 * Last update: 29.10.2021 14:08:58
 * Ticket ID: ... / [1210]
 * Generated for WebSite: [https://learniv.com]
 * User ID: [1]    
 * Custom ticket name: [Testing 2 DEV statistiky]
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910535 = document.querySelector("#new-rectangle-desktop") !== null;
    console.log('ID: new-rectangle-desktop / check910535: ' + check910535);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910541 = document.querySelector("#new-square-mobil-1") !== null;
    console.log('ID: new-square-mobil-1 / check910541: ' + check910541);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910542 = document.querySelector("#new_square_pc-2") !== null;
    console.log('ID: new_square_pc-2 / check910542: ' + check910542);
...
// unitResponzivita:all
  if(((imHbWindowWidth >= 1) && (imHbWindowWidth <= 9999))){
    ...
    var check910538 = document.querySelector("#square") !== null;
    console.log('ID: square / check910538: ' + check910538);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910533 = document.querySelector("#learniv-300x600") !== null;
    console.log('ID: learniv-300x600 / check910533: ' + check910533);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910539 = document.querySelector("#nobranding") !== null;
    console.log('ID: nobranding / check910539: ' + check910539);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910532 = document.querySelector("#patickovy-leaderboard-mobil") !== null;
    console.log('ID: patickovy-leaderboard-mobil / check910532: ' + check910532);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910534 = document.querySelector("#patickovy-leaderboard-desktop") !== null;
    console.log('ID: patickovy-leaderboard-desktop / check910534: ' + check910534);
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1210&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
