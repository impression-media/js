...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 2 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        checkReloadingAdsRestriction = 2 - (15 - imHbReloadingAds);
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 2 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
    checkReloadingAdsRestriction = 2 - (15 - imHbReloadingAds);
