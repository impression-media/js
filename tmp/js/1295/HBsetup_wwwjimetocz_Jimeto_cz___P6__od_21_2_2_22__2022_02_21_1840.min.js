...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(!!(window.attachEvent && !window.opera)) {
        cssId911204Mid1090690.styleSheet.cssText = '#adformMobilniBranding iframe {max-width: 1000;}';
    } else {
        var styleText911204Mid1090690 = document.createTextNode('#adformMobilniBranding iframe {max-width: 1000;}');
