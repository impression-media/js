 ...
 * Last update: 21.02.2022  18:42
 * Generated for WebSite: [https://www.jimeto.cz] 
 * Custom ticket name: [Jimeto.cz - P6 (od 21.2.2022)]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1295]
 * User ID: [1]    
...
var webFloor = 0.00;
var webResponzivitaRange = 'mobil::999:';
var webBidders = 'cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,adform-omd';    
var placementFloor = { 
...
var tierAlias = { 
    "1090690": "adform_mobilnibranding",
};
var responzivita = { 
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 2 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
        checkReloadingAdsRestriction = 2 - (1 - imHbReloadingAds);
        ...
        console.log('ID: adformMobilniBranding / MID:1090690 / DIV ID found: ' + responsiveConditionReady);
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            document.querySelector("#adformMobilniBranding").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript id=\'im-script-adformMobilniBranding\' src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=1090690"></scr'+'ipt>'; 
            document.querySelector("#adformMobilniBranding").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 2');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adformMobilniBranding").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 2');
            }
        }
    }else{ 
        nonResponsiveLeaveBlank = document.querySelector("#adformMobilniBranding") !== null;
        console.log('ID: adformMobilniBranding / MID:1090690 / DIV ID found: ' + nonResponsiveLeaveBlank);
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1295&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 2 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 2 - (1 - imHbReloadingAds);
    
        var delId911204Mid1090690 = document.querySelector("#cssId911204Mid1090690") !== null;
        if (delId911204Mid1090690) {
            document.querySelector('#cssId911204Mid1090690').remove();
        }
    
    var cssId911204Mid1090690 = document.createElement('style');
    cssId911204Mid1090690.type = 'text/css';
    cssId911204Mid1090690.id = 'cssId911204Mid1090690';
    if(!!(window.attachEvent && !window.opera)) {
        cssId911204Mid1090690.styleSheet.cssText = '#adformMobilniBranding iframe {max-width: 1000px;}';
    } else {
        var styleText911204Mid1090690 = document.createTextNode('#adformMobilniBranding iframe {max-width: 1000px;}');
        cssId911204Mid1090690.appendChild(styleText911204Mid1090690);
    }
    document.getElementsByTagName('head')[0].appendChild(cssId911204Mid1090690);
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adformMobilniBranding / hbPlacement1090690: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['adformMobilniBranding'] = '1090690';
        }else{
            console.log('hbPlacement for unitCustomID adformMobilniBranding is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adformMobilniBranding / 1090690  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwjimetocz-1-1295-911204',
            code: 'adformMobilniBranding',
                mediaTypes: {
                   banner: {sizes: [
               [320,50],[320,150],[300,100],[300,50],[300,300],[300,250],[336,280],[250,250],[300,150],[480,300],[970,350],[970,250],[970,210],[970,90],[970,310],[728,90],[300,120],[500,200],[320,100],[320,100]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "jimeto/Mobilnibranding_1090690",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        } pbjs.WEURON_MapPositions['adformMobilniBranding'] = '1090690';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adformMobilniBranding / 1090690  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1090690 = document.querySelector("#adformMobilniBranding") !== null;
//      console.log('ID: adformMobilniBranding / check1090690: ' + check1090690);
//      if (check1090690) {
