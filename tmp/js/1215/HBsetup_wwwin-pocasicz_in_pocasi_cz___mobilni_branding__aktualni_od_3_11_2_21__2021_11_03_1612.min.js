...
pbjs.onEvent('auctionEnd', function(data){
    ...
    jsId910587Mid428711.innerHTML = "var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('after topBoxWraperADF2000 ' + selection );if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}";
