...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    jsId910587Mid428711.innerHTML = "var selection = top.document.querySelector('body') !== null;if (selection) {top.document.body.style.marginTop = '0px';}";
