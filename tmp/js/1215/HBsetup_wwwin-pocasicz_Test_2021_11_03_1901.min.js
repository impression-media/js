...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 1)) {    
    ...
    console.log('AdTrackGenericInterscrollerDesktop : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 1)) {    
            ...
            document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 3');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 3');
            }
        }
    }else{ 
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 1){
...
pbjs.onEvent('auctionEnd', function(data){
    ...
    jsId910587Mid428711.innerHTML = "setTimeout(function(){ var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('after 3000 topBoxWraperADF2000 ' + selection );if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}}, 3000);setTimeout(function(){ var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('after 5000 topBoxWraperADF2000 ' + selection );if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}}, 5000);";
