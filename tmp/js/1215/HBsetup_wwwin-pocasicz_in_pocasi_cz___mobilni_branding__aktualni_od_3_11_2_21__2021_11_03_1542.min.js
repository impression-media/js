 ...
 * Last update: 03.11.2021  15:42
 * Generated for WebSite: [https://www.in-pocasi.cz] 
 * Custom ticket name: [in-pocasi.cz + mobilni branding (aktualni od 3.11.2021)]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1215]
 * User ID: [1]    
...
var webBidders = 'cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,stroeerCore,PubMatic,Teads,adform-im-tt_id_2,r2b2_id_2';    
var placementFloor = { 
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910587 = document.querySelector("#adform_leaderboard iframe").style.height;
            if(imMinHeight910587 == '0px'){
                var imMinHeight910587 = document.querySelector("#adform_leaderboard iframe").height;
            }
            //document.querySelector("#adform_leaderboard").setAttribute('im-min-height', imMinHeight910587); 
            console.log('set imMinHeight >> imMinHeight910587: '+imMinHeight910587);
            if((imMinHeight910587 == '1400px')||(imMinHeight910587 == '1400')){
                document.querySelector("#adform_leaderboard").style.minHeight = '0px';
                document.querySelector("#adform_leaderboard iframe").style.display = 'none';
            }else{
                if((imMinHeight910587 == '0px')||(imMinHeight910587 == '0')){
                    var selection = document.querySelectorAll('#adform_leaderboard iframe')[1] !== null;
                    if (selection) {
                        imMinHeight910587 = document.querySelectorAll('#adform_leaderboard iframe')[1].style.height;
                        if(imMinHeight910587 == '0px'){
                            imMinHeight910587 = document.querySelectorAll('#adform_leaderboard iframe')[1].height;
                            document.querySelector("#adform_leaderboard").style.minHeight = imMinHeight910587+'px';
                        }else{
                            document.querySelector("#adform_leaderboard").style.minHeight = imMinHeight910587;
                        } 
                    }
                }else{
                    document.querySelector("#adform_leaderboard").style.minHeight = imMinHeight910587;
    ...
    console.log('adform_square : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910588 = document.querySelector("#adform_square iframe").style.height;
            if(imMinHeight910588 == '0px'){
                var imMinHeight910588 = document.querySelector("#adform_square iframe").height;
            }
            //document.querySelector("#adform_square").setAttribute('im-min-height', imMinHeight910588); 
            console.log('set imMinHeight >> imMinHeight910588: '+imMinHeight910588);
            if((imMinHeight910588 == '1400px')||(imMinHeight910588 == '1400')){
                document.querySelector("#adform_square").style.minHeight = '0px';
                document.querySelector("#adform_square iframe").style.display = 'none';
            }else{
                if((imMinHeight910588 == '0px')||(imMinHeight910588 == '0')){
                    var selection = document.querySelectorAll('#adform_square iframe')[1] !== null;
                    if (selection) {
                        imMinHeight910588 = document.querySelectorAll('#adform_square iframe')[1].style.height;
                        if(imMinHeight910588 == '0px'){
                            imMinHeight910588 = document.querySelectorAll('#adform_square iframe')[1].height;
                            document.querySelector("#adform_square").style.minHeight = imMinHeight910588+'px';
                        }else{
                            document.querySelector("#adform_square").style.minHeight = imMinHeight910588;
                        } 
                    }
                }else{
                    document.querySelector("#adform_square").style.minHeight = imMinHeight910588;
    ...
    console.log('adform_square2 : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910589 = document.querySelector("#adform_square2 iframe").style.height;
            if(imMinHeight910589 == '0px'){
                var imMinHeight910589 = document.querySelector("#adform_square2 iframe").height;
            }
            //document.querySelector("#adform_square2").setAttribute('im-min-height', imMinHeight910589); 
            console.log('set imMinHeight >> imMinHeight910589: '+imMinHeight910589);
            if((imMinHeight910589 == '1400px')||(imMinHeight910589 == '1400')){
                document.querySelector("#adform_square2").style.minHeight = '0px';
                document.querySelector("#adform_square2 iframe").style.display = 'none';
            }else{
                if((imMinHeight910589 == '0px')||(imMinHeight910589 == '0')){
                    var selection = document.querySelectorAll('#adform_square2 iframe')[1] !== null;
                    if (selection) {
                        imMinHeight910589 = document.querySelectorAll('#adform_square2 iframe')[1].style.height;
                        if(imMinHeight910589 == '0px'){
                            imMinHeight910589 = document.querySelectorAll('#adform_square2 iframe')[1].height;
                            document.querySelector("#adform_square2").style.minHeight = imMinHeight910589+'px';
                        }else{
                            document.querySelector("#adform_square2").style.minHeight = imMinHeight910589;
                        } 
                    }
                }else{
                    document.querySelector("#adform_square2").style.minHeight = imMinHeight910589;
    ...
    console.log('AdTrackGenericInterscrollerDesktop : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        checkReloadingAdsRestriction = 3 - (15 - imHbReloadingAds);
        ...
        setTimeout(function(){
            var imMinHeight910590 = document.querySelector("#AdTrackGenericInterscrollerDesktop iframe").style.height;
            if(imMinHeight910590 == '0px'){
                var imMinHeight910590 = document.querySelector("#AdTrackGenericInterscrollerDesktop iframe").height;
            }
            //document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('im-min-height', imMinHeight910590); 
            console.log('set imMinHeight >> imMinHeight910590: '+imMinHeight910590);
            if((imMinHeight910590 == '1400px')||(imMinHeight910590 == '1400')){
                document.querySelector("#AdTrackGenericInterscrollerDesktop").style.minHeight = '0px';
                document.querySelector("#AdTrackGenericInterscrollerDesktop iframe").style.display = 'none';
            }else{
                if((imMinHeight910590 == '0px')||(imMinHeight910590 == '0')){
                    var selection = document.querySelectorAll('#AdTrackGenericInterscrollerDesktop iframe')[1] !== null;
                    if (selection) {
                        imMinHeight910590 = document.querySelectorAll('#AdTrackGenericInterscrollerDesktop iframe')[1].style.height;
                        if(imMinHeight910590 == '0px'){
                            imMinHeight910590 = document.querySelectorAll('#AdTrackGenericInterscrollerDesktop iframe')[1].height;
                            document.querySelector("#AdTrackGenericInterscrollerDesktop").style.minHeight = imMinHeight910590+'px';
                        }else{
                            document.querySelector("#AdTrackGenericInterscrollerDesktop").style.minHeight = imMinHeight910590;
                        } 
                    }
                }else{
                    document.querySelector("#AdTrackGenericInterscrollerDesktop").style.minHeight = imMinHeight910590;
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910591 = document.querySelector("#adformMobilniBranding iframe").style.height;
            if(imMinHeight910591 == '0px'){
                var imMinHeight910591 = document.querySelector("#adformMobilniBranding iframe").height;
            }
            //document.querySelector("#adformMobilniBranding").setAttribute('im-min-height', imMinHeight910591); 
            console.log('set imMinHeight >> imMinHeight910591: '+imMinHeight910591);
            if((imMinHeight910591 == '1400px')||(imMinHeight910591 == '1400')){
                ...
                if((imMinHeight910591 == '0px')||(imMinHeight910591 == '0')){
                    var selection = document.querySelectorAll('#adformMobilniBranding iframe')[1] !== null;
                    if (selection) {
                        imMinHeight910591 = document.querySelectorAll('#adformMobilniBranding iframe')[1].style.height;
                        if(imMinHeight910591 == '0px'){
                            imMinHeight910591 = document.querySelectorAll('#adformMobilniBranding iframe')[1].height;
                            document.querySelector("#adformMobilniBranding").style.minHeight = imMinHeight910591+'px';
                        }else{
                            document.querySelector("#adformMobilniBranding").style.minHeight = imMinHeight910591;
                        } 
                    }
                }else{
                    document.querySelector("#adformMobilniBranding").style.minHeight = imMinHeight910591;
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1215&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){ 
        ...
        var remId910587Mid428711 = document.querySelector("#jsId910587Mid428711") !== null;
        if (remId910587Mid428711) {
            document.querySelector('#jsId910587Mid428711').remove();
        }
    
    var jsId910587Mid428711 = document.createElement('script');
    jsId910587Mid428711.type = 'text/javascript';
    jsId910587Mid428711.id = 'jsId910587Mid428711';
    jsId910587Mid428711.innerHTML = "var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('topBoxWraperADF2000:'+selection);if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}setTimeout(function(){ var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('1000ms topBoxWraperADF2000'+selection);if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}}, 1000);setTimeout(function(){ var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('2000ms topBoxWraperADF2000'+selection );if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}}, 2000);";
    document.body.appendChild(jsId910587Mid428711);
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1215-910587',
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1215-910588',
            code: 'adform_square',
                mediaTypes: {
                   banner: {sizes: [
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1215-910589',
            code: 'adform_square2',
                mediaTypes: {
                   banner: {sizes: [
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1215-910590',
...
//      }
    ...
    console.log('URL condition >>  include / typ regex / string: .*');
        ...
        var selection = document.querySelector('[data-adtrack-id^="classic_in-pocasi"]') !== null;
        if (selection) {
            console.log('remove querySelector:: [data-adtrack-id^="classic_in-pocasi"]');
            document.querySelector('[data-adtrack-id^="classic_in-pocasi"]').remove();
        };
        
        var selection = document.querySelector('[data-adtrack-id^="mobile_in-pocasi"]') !== null;
        if (selection) {
            console.log('remove querySelector:: [data-adtrack-id^="mobile_in-pocasi"]');
            document.querySelector('[data-adtrack-id^="mobile_in-pocasi"]').remove();
        };
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1215-910591',
