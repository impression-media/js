...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 1)) {    
            ...
            document.querySelector("#adform_leaderboard").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction);

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_leaderboard").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction);
            }
        }
    }else{ 
    ...
    console.log('adform_square : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 1)) {    
            ...
            document.querySelector("#adform_square").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction);

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_square").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction);
            }
        }
    }else{ 
    ...
    console.log('adform_square2 : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 1)) {    
            ...
            document.querySelector("#adform_square2").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction);

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_square2").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction);
            }
        }
    }else{ 
    ...
    console.log('AdTrackGenericInterscrollerDesktop : DEV TEST >> unitReloadingAdsRestriction: 3 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 1)) {    
            ...
            document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction);

        }else{
            if (responsiveConditionReady){
                document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction);
            }
        }
    }else{ 
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 1)) {    
            ...
            document.querySelector("#adformMobilniBranding").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction);

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adformMobilniBranding").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction);
            }
        }
    }else{ 
