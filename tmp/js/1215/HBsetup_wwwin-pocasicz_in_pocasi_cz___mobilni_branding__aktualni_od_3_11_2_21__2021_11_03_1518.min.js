...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    jsId910587Mid428711.innerHTML = "var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('topBoxWraperADF2000:'+selection);if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}setTimeout(function(){ var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('1000ms topBoxWraperADF2000');if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}}, 1000);setTimeout(function(){ var selection = top.document.querySelector('#topBoxWraperADF2000') !== null;console.log('2000ms topBoxWraperADF2000');if (selection) {top.document.body.style.marginTop = '210px';}else{top.document.body.style.marginTop = '0px';}}, 2000);";
