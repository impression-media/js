...
var checkReloadingAdsRestriction;
    ...
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#square-sidebar-desktop").innerHTML ='<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 1; 
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#square-sidebar-mobil").innerHTML ='<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 1; 
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#rectanglem").innerHTML ='<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
...
function statisticsAuctionEnd(data, kam){
    ...
    xhr.open('GET','https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1177&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
