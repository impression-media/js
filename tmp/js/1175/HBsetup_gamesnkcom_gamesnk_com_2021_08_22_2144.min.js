...
var bidderFloor = {"criteo-im": 3,"adform-im-tt": 3,"adform-im-nt": 3,"appnexus": 3,"Teads": 3
};
var webFloor = 1.00;
var webResponzivitaRange ='All:1:9999:|desktop:1000::|mobil::999:';
var webBidders ='criteo-im,adform-im-tt,adform-im-nt,appnexus,Teads';    
...
var bidderAlias = {"criteo-im":"criteo","adform-im-tt":"adform","adform-im-nt":"adform","appnexus":"appnexus","Teads":"teads"};
var tierAlias = {"1033805":"adform_square","1033809":"adform_leaderboard","1033816":"adform_leaderboardm","1033819":"adform_leaderboard2","1033824":"adform_leaderboardm2","1033826":"adform_square2","1033828":"adform_squarem2","1055318":"adform_rectanglem",
};
...
pbjs.adUnits = [];
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 9999))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#square1").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1033805"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'gamesnkcom-1-1175-910281',
            code:'square1',
                mediaTypes: {
                   banner: {sizes: [
               [250,250],[200,200]
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#top-leaderboard-desktop").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1033809"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'gamesnkcom-1-1175-910282',
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#top-leaderboard-mobil").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1033816"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'gamesnkcom-1-1175-910283',
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#bottom-leaderboard-desktop").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1033819"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'gamesnkcom-1-1175-910284',
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#bottom-leaderboard-mobil").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1033824"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'gamesnkcom-1-1175-910285',
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#square-sidebar-desktop").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1033826"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'gamesnkcom-1-1175-910286',
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#square-sidebar-mobil").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1033828"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'gamesnkcom-1-1175-910287',
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 9999))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#rectanglem").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1055318"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'gamesnkcom-1-1175-910338',
            code:'rectanglem',
                mediaTypes: {
                   banner: {sizes: [
