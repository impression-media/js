 ...
 * Last update: 29.10.2021 14:11:04
 * Ticket ID: ... / [1211]
 * Generated for WebSite: [https://learniv.com]
 * User ID: [1]    
 * Custom ticket name: [Testing 3 DEV statistiky]
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910546 = document.querySelector("#new-rectangle-desktop") !== null;
    console.log('ID: new-rectangle-desktop / check910546: ' + check910546);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910552 = document.querySelector("#new-square-mobil-1") !== null;
    console.log('ID: new-square-mobil-1 / check910552: ' + check910552);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910553 = document.querySelector("#new_square_pc-2") !== null;
    console.log('ID: new_square_pc-2 / check910553: ' + check910553);
...
// unitResponzivita:all
  if(((imHbWindowWidth >= 1) && (imHbWindowWidth <= 9999))){
    ...
    var check910549 = document.querySelector("#square") !== null;
    console.log('ID: square / check910549: ' + check910549);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910544 = document.querySelector("#learniv-300x600") !== null;
    console.log('ID: learniv-300x600 / check910544: ' + check910544);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910550 = document.querySelector("#nobranding") !== null;
    console.log('ID: nobranding / check910550: ' + check910550);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910543 = document.querySelector("#patickovy-leaderboard-mobil") !== null;
    console.log('ID: patickovy-leaderboard-mobil / check910543: ' + check910543);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910545 = document.querySelector("#patickovy-leaderboard-desktop") !== null;
    console.log('ID: patickovy-leaderboard-desktop / check910545: ' + check910545);
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1211&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
