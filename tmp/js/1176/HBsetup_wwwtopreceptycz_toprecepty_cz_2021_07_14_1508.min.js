 ...
 * Last update: 14.07.2021  15:08
 * Generated for WebSite: [https://www.toprecepty.cz] 
 * Custom ticket name: [toprecepty.cz]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1176]
 * User ID: [1]    
...
var webBidders = 'cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,stroeerCore,PubMatic,Teads';    
var placementFloor = { 
    ...
    "adformsquare3": 1.00,
    "adformsquare2": 1.00,
    "adformrectangle": 1.00,
    "adformrectanglem": 1.00,
...
var tierAlias = { 
    "823022": "adform_leaderboard",
    "823035": "adform_square",
    "857241": "adform_squarem",
    "904571": "adform_square3",
    "904591": "adform_square2",
    "1032716": "adform_rectangle",
    "1032720": "adform_rectanglem",
    "1032626": "adform_interscroller",
    "1023544": "adform_mobilnibranding",
};
var responzivita = { 
    "adform_leaderboard": "desktop",
    "adform_square": "desktop",
    "adform_squarem": "mobil",
    "adform_square3": "desktop",
    "adform_square2": "desktop",
    "adform_rectangle": "desktop",
    "adform_rectanglem": "mobil",
...
var checkReloadingAdsRestriction; 
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 2 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 2 - (10 - imHbReloadingAds);
    ...
    if (checkReloadingAdsRestriction > 0) {
        ...
        console.log('ID: adform_leaderboard / MID:823022 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#adform_leaderboard").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('adform_square : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1 - (10 - imHbReloadingAds);
    ...
    if (checkReloadingAdsRestriction > 0) {
        ...
        console.log('ID: adform_square / MID:823035 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#adform_square").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('adform_squarem : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1 - (10 - imHbReloadingAds);
    ...
    if (checkReloadingAdsRestriction > 0) {
        ...
        console.log('ID: adform_squarem / MID:857241 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#adform_squarem").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('adform_square3 : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1 - (10 - imHbReloadingAds);
    ...
    if (checkReloadingAdsRestriction > 0) {
        ...
        console.log('ID: adform_square3 / MID:904571 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#adform_square3").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('adform_square2 : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1 - (10 - imHbReloadingAds);
    ...
    if (checkReloadingAdsRestriction > 0) {
        ...
        console.log('ID: adform_square2 / MID:904591 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#adform_square2").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('adform_rectangle : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1 - (10 - imHbReloadingAds);
    
    console.log('imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction); 
    if (checkReloadingAdsRestriction > 0) {
        console.log('adform_rectangle : REMOVE imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);     
        nonResponsiveLeaveBlank = document.querySelector("#adform_rectangle") !== null;
        console.log('ID: adform_rectangle / MID:1032716 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#adform_rectangle").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('adform_rectanglem : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1 - (10 - imHbReloadingAds);
    
    console.log('imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction); 
    if (checkReloadingAdsRestriction > 0) {
        console.log('adform_rectanglem : REMOVE imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);     
        nonResponsiveLeaveBlank = document.querySelector("#adform_rectanglem") !== null;
        console.log('ID: adform_rectanglem / MID:1032720 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#adform_rectanglem").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('AdTrackGenericInterscrollerDesktop : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1 - (10 - imHbReloadingAds);
    ...
    if (checkReloadingAdsRestriction > 0) {
        ...
        console.log('ID: AdTrackGenericInterscrollerDesktop / MID:1032626 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#AdTrackGenericInterscrollerDesktop").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    ...
    if (checkReloadingAdsRestriction > 0) {
        ...
        console.log('ID: adformMobilniBranding / MID:1023544 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 2 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 2 - (10 - imHbReloadingAds);
    
    if(checkReloadingAdsRestriction > 0){ 
        top.document.body.setAttribute('im-s', 'start');    
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_leaderboard / hbPlacement823022: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#adform_leaderboard").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=823022"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: adform_leaderboard / 823022  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910288',
            code: 'adform_leaderboard',
                mediaTypes: {
                   banner: {sizes: [
               [970,210],[970,90],[970,100],[750,100],[970,200],[745,200],[745,100],[728,90],[930,180],[750,200],[2000,1400]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "toprecepty/Leaderboard_823022",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "c54ac10d-5817-4419-8156-8b146f02d859",    
                        }                
                },
                {
                    "bidder": "PubMatic",
        ...
        } pbjs.WEURON_MapPositions ['adform_leaderboard'] = '823022';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: adform_leaderboard / 823022  (' + pbjs.WEURON_WindowWidth + ')');
//      var check823022 = document.querySelector("#adform_leaderboard") !== null;
//      console.log('ID: adform_leaderboard / check823022: ' + check823022);
//      if (check823022) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1 - (10 - imHbReloadingAds);
    
    console.log('PROD >> imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#adform_square") !== null;
        console.log('ID: adform_square / hbPlacement823035: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#adform_square").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=823035"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: adform_square / 823035  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910289',
            code: 'adform_square',
                mediaTypes: {
                   banner: {sizes: [
               [300,300],[300,250],[250,250],[160,600],[120,600],[200,600]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "toprecepty/Square_823035",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "99f59c53-7d7b-4f63-a507-a7d579a24411",    
                        }                
                },
                {
                    "bidder": "PubMatic",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['adform_square'] = '823035';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: adform_square / 823035  (' + pbjs.WEURON_WindowWidth + ')');
//      var check823035 = document.querySelector("#adform_square") !== null;
//      console.log('ID: adform_square / check823035: ' + check823035);
//      if (check823035) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_squarem / hbPlacement857241: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#adform_squarem").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=857241"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: adform_squarem / 857241  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910290',
            code: 'adform_squarem',
                mediaTypes: {
                   banner: {sizes: [
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "toprecepty/Square_mobile_857241",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "08f0989d-22e9-4ee1-8410-8b9ba0273ba2",    
                        }                
                },
                {
                    "bidder": "PubMatic",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['adform_squarem'] = '857241';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: adform_squarem / 857241  (' + pbjs.WEURON_WindowWidth + ')');
//      var check857241 = document.querySelector("#adform_squarem") !== null;
//      console.log('ID: adform_squarem / check857241: ' + check857241);
//      if (check857241) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_square3 / hbPlacement904571: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#adform_square3").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=904571"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: adform_square3 / 904571  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910291',
            code: 'adform_square3',
                mediaTypes: {
                   banner: {sizes: [
               [300,250],[250,250],[200,200]
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "toprecepty/Square_300x300_1_904571",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "905846f8-2ba4-43f2-a88c-36fe19d19915",    
                        }                
                },
                {
                    "bidder": "PubMatic",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['adform_square3'] = '904571';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: adform_square3 / 904571  (' + pbjs.WEURON_WindowWidth + ')');
//      var check904571 = document.querySelector("#adform_square3") !== null;
//      console.log('ID: adform_square3 / check904571: ' + check904571);
//      if (check904571) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_square2 / hbPlacement904591: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#adform_square2").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=904591"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: adform_square2 / 904591  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910292',
            code: 'adform_square2',
                mediaTypes: {
                   banner: {sizes: [
               [300,250],[250,250],[200,200]
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "toprecepty/Square_300x300_2_904591",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "4ebc3c4b-4c44-4d10-96c0-ce258a4edb54",    
                        }                
                },
                {
                    "bidder": "PubMatic",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['adform_square2'] = '904591';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: adform_square2 / 904591  (' + pbjs.WEURON_WindowWidth + ')');
//      var check904591 = document.querySelector("#adform_square2") !== null;
//      console.log('ID: adform_square2 / check904591: ' + check904591);
//      if (check904591) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_rectangle / hbPlacement1032716: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#adform_rectangle").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1032716"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: adform_rectangle / 1032716  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910294',
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "toprecepty/rectangle_pod_clankem_1032716",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['adform_rectangle'] = '1032716';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: adform_rectangle / 1032716  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1032716 = document.querySelector("#adform_rectangle") !== null;
//      console.log('ID: adform_rectangle / check1032716: ' + check1032716);
//      if (check1032716) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_rectanglem / hbPlacement1032720: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#adform_rectanglem").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1032720"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: adform_rectanglem / 1032720  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910295',
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "toprecepty/rectangle_pod_clankem_mobile_1032720",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['adform_rectanglem'] = '1032720';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: adform_rectanglem / 1032720  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1032720 = document.querySelector("#adform_rectanglem") !== null;
//      console.log('ID: adform_rectanglem / check1032720: ' + check1032720);
//      if (check1032720) {
//          document.querySelector("#adform_rectanglem").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: AdTrackGenericInterscrollerDesktop / hbPlacement1032626: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#AdTrackGenericInterscrollerDesktop").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1032626"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: AdTrackGenericInterscrollerDesktop / 1032626  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910296',
...
//          "refresh_limit": 0,        
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['AdTrackGenericInterscrollerDesktop'] = '1032626';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: AdTrackGenericInterscrollerDesktop / 1032626  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1032626 = document.querySelector("#AdTrackGenericInterscrollerDesktop") !== null;
//      console.log('ID: AdTrackGenericInterscrollerDesktop / check1032626: ' + check1032626);
//      if (check1032626) {
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 1000 - (10 - imHbReloadingAds);
    
    console.log('PROD >> imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#adformMobilniBranding") !== null;
        console.log('ID: adformMobilniBranding / hbPlacement1023544: ' + hbPlacement);
        if (hbPlacement) {
            document.querySelector("#adformMobilniBranding").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1023544"></scr'+'ipt>';            
           }

        console.log('Responzivita = TRUE >> Placement / MID: adformMobilniBranding / 1023544  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwtopreceptycz-1-1176-910297',
            code: 'adformMobilniBranding',
                mediaTypes: {
                   banner: {sizes: [
               [320,50],[300,100],[300,50],[300,150],[300,120],[300,300],[300,250],[250,250],[336,280],[480,300],[728,90],[970,350],[970,250],[970,210],[970,90],[9470,310],[320,150]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "toprecepty/MobilniBranding_1023544",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['adformMobilniBranding'] = '1023544';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: adformMobilniBranding / 1023544  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1023544 = document.querySelector("#adformMobilniBranding") !== null;
//      console.log('ID: adformMobilniBranding / check1023544: ' + check1023544);
//      if (check1023544) {
