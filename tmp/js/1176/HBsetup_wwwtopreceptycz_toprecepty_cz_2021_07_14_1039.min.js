...
pbjs.WEURON_HbMin = 5;
var hbConfigOnloadTimeout = 3000;
var bidderFloor = { 
    "cpex-tt": 3,
    "criteo-im": 3,
    "adform-im-tt": 3,
...
var checkReloadingAdsRestriction; 
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 0 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 0 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 10' + '' );
    checkReloadingAdsRestriction = 0 - (10 - imHbReloadingAds);
