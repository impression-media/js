...
var adfScriptImpl = 'With AdForm script (1)';
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 20' + '' );
