 ...
 * Last update: 06.01.2022  16:33
 * Generated for WebSite: [https://bez-bazaru.cz] 
 * Custom ticket name: [bez-bazaru.cz]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1179]
 * User ID: [1]    
...
var webFloor = 0.00;
var webResponzivitaRange = 'desktop:1000::|All:1:10000:';
...
var tierAlias = { 
    "993840": "adform_leaderboard",
    "993843": "adform_square",
};
var responzivita = { 
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    checkReloadingAdsRestriction = 1; 
        ...
        console.log('ID: adform_leaderboard / MID:993840 / DIV ID found: ' + nonResponsiveLeaveBlank);
    ...
    checkReloadingAdsRestriction = 1; 
        ...
        console.log('ID: adform_square / MID:993843 / DIV ID found: ' + responsiveConditionReady);
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            document.querySelector("#adform_square").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript id=\'im-script-adform_square\' src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=993843"></scr'+'ipt>'; 
        ...
        console.log('ID: adform_square / MID:993843 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1179&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_leaderboard / hbPlacement993840: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['adform_leaderboard'] = '993840';
        }else{
            console.log('hbPlacement for unitCustomID adform_leaderboard is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adform_leaderboard / 993840  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'bez-bazarucz-1-1179-910319',
            code: 'adform_leaderboard',
                mediaTypes: {
                   banner: {sizes: [
               [980,200],[745,100],[728,90],[750,200],[750,100],[990,100],[990,110],[990,200],[980,120],[920,200],[900,200],[970,200],[970,100],[1000,100],[998,200],[745,200],[970,90]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
            
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "bez-bazaru/Leaderboard_paticka_993840",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "516513cb-4080-481c-b153-00864d4ccb46",    
                        }                
                },
                {
                    "bidder": "adform-omd",
        ...
        } pbjs.WEURON_MapPositions['adform_leaderboard'] = '993840';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adform_leaderboard / 993840  (' + pbjs.WEURON_WindowWidth + ')');
//      var check993840 = document.querySelector("#adform_leaderboard") !== null;
//      console.log('ID: adform_leaderboard / check993840: ' + check993840);
//      if (check993840) {
...
//  Web Variableexclude#@##@#
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if('adformMobilniBranding' == ''){hbPlacement = true;} 
        console.log('ID: adform_square / hbPlacement993843: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['adform_square'] = '993843';
        }else{
            console.log('hbPlacement for unitCustomID adform_square is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adform_square / 993843  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'bez-bazarucz-1-1179-910320',
            code: 'adform_square',
                mediaTypes: {
                   banner: {sizes: [
...
//          "refresh_limit": 0,        
            ...
            "bids": [
            
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "bez-bazaru/Square_993843",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "3a426791-4533-436e-b1bc-4ce3da98baa2",    
                        }                
                },
                {
                    "bidder": "adform-omd",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions['adform_square'] = '993843';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adform_square / 993843  (' + pbjs.WEURON_WindowWidth + ')');
//      var check993843 = document.querySelector("#adform_square") !== null;
//      console.log('ID: adform_square / check993843: ' + check993843);
//      if (check993843) {
