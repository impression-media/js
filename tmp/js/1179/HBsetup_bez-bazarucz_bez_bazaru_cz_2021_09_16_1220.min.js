...
var bidderFloor = {"criteo-im": 3,"adform-im-tt": 3,"adform-im-nt": 3,"stroeerCore": 5
};
var webFloor = 0.00;
...
var bidderAlias = {"criteo-im":"criteo","adform-im-tt":"adform","adform-im-nt":"adform","stroeerCore":"stroeerCore"};
...
pbjs.adUnits = [];
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_leaderboard").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=993840"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_square").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=993843"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
