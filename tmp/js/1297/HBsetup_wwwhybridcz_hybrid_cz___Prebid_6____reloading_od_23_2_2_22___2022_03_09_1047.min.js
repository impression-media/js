...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    jsId911217Mid428698.innerHTML = "var checkTopLeaderboard = document.querySelector('#adform_leaderboard');checkTopLeaderboard.style.height= '210px';checkTopLeaderboard.style.marginTop= '0px'";
