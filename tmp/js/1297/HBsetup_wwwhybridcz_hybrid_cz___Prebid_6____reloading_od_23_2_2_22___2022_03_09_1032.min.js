 ...
 * Last update: 09.03.2022  10:32
 * Generated for WebSite: [http://www.hybrid.cz] 
 * Custom ticket name: [hybrid.cz - Prebid 6 (+ reloading od 23.2.2022) ]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1297]
 * User ID: [1]    
...
var webFloor = 0.00;
var webResponzivitaRange = 'ALL:1:10000:|desktop:1200::';
var webBidders = 'cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,stroeerCore,Teads,adform-omd,r2b2';    
var placementFloor = { 
    "adformsquare": 0.00,
...
var tierAlias = { 
    "428699": "adform_square",
    "428698": "adform_leaderboard",
};
var responzivita = { 
    "adform_square": "ALL",
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('adform_square : DEV TEST >> unitReloadingAdsRestriction: 4 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 4' + '' );
        ...
        console.log('ID: adform_square / MID:428699 / DIV ID found: ' + responsiveConditionReady);
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            document.querySelector("#adform_square").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript id=\'im-script-adform_square\' src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=428699"></scr'+'ipt>'; 
            document.querySelector("#adform_square").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 4');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_square").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 4');
            }
        }
    }else{ 
        nonResponsiveLeaveBlank = document.querySelector("#adform_square") !== null;
        console.log('ID: adform_square / MID:428699 / DIV ID found: ' + nonResponsiveLeaveBlank);
    ...
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 4 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 4' + '' );
        checkReloadingAdsRestriction = 4 - (4 - imHbReloadingAds);
        ...
        console.log('ID: adform_leaderboard / MID:428698 / DIV ID found: ' + responsiveConditionReady);
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            document.querySelector("#adform_leaderboard").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript id=\'im-script-adform_leaderboard\' src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=428698"></scr'+'ipt>'; 
            document.querySelector("#adform_leaderboard").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 4');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_leaderboard").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 4');
            }
        }
    }else{ 
        nonResponsiveLeaveBlank = document.querySelector("#adform_leaderboard") !== null;
        console.log('ID: adform_leaderboard / MID:428698 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1297&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
...
//  Web Variableexclude#@##@#
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 4 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 4' + '' );
    checkReloadingAdsRestriction = 4 - (4 - imHbReloadingAds);
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adform_square / hbPlacement428699: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['adform_square'] = '428699';
        }else{
            console.log('hbPlacement for unitCustomID adform_square is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adform_square / 428699  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwhybridcz-1-1297-911216',
            code: 'adform_square',
                mediaTypes: {
                   banner: {sizes: [
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "hybrid/Square_428699",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "142e5611-e8ae-4d14-a2c2-40ef77d5e865",    
                        }                
                }
              ]
            }
        ...
        } pbjs.WEURON_MapPositions['adform_square'] = '428699';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adform_square / 428699  (' + pbjs.WEURON_WindowWidth + ')');
//      var check428699 = document.querySelector("#adform_square") !== null;
//      console.log('ID: adform_square / check428699: ' + check428699);
//      if (check428699) {
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){ 
        ...
        var remId911217Mid428698 = document.querySelector("#jsId911217Mid428698") !== null;
        if (remId911217Mid428698) {
            document.querySelector('#jsId911217Mid428698').remove();
        }
    
    var jsId911217Mid428698 = document.createElement('script');
    jsId911217Mid428698.type = 'text/javascript';
    jsId911217Mid428698.id = 'jsId911217Mid428698';
    jsId911217Mid428698.innerHTML = "var checkTopLeaderboard = document.querySelector('#adform_leaderboard'); checkTopLeaderboard.addEventListener('DOMSubtreeModified', function(){ console.log('DOMSubtreeModified start');});";
    document.body.appendChild(jsId911217Mid428698);

    console.log('PROD >> imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#adform_leaderboard") !== null;
        if('adformMobilniBranding' == ''){hbPlacement = true;} 
        console.log('ID: adform_leaderboard / hbPlacement428698: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['adform_leaderboard'] = '428698';
        }else{
            console.log('hbPlacement for unitCustomID adform_leaderboard is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adform_leaderboard / 428698  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwhybridcz-1-1297-911217',
            code: 'adform_leaderboard',
                mediaTypes: {
                   banner: {sizes: [
               [970,210],[970,90],[970,100],[970,200],[920,200],[930,180],[960,100],[900,200],[750,200],[750,100],[745,200],[745,100],[728,90],[468,60],[2000,1400]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "hybrid/Leaderboard_428698",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
                ...
                },
                {
                    ...
                    "bidderCode": "stroeerCore",        
                        "params": {
                               sid: "d8a60869-33ba-47fc-bb1c-aebafffa2f28",    
                        }                
                },
                {
                    "bidder": "adform-omd",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions['adform_leaderboard'] = '428698';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adform_leaderboard / 428698  (' + pbjs.WEURON_WindowWidth + ')');
//      var check428698 = document.querySelector("#adform_leaderboard") !== null;
//      console.log('ID: adform_leaderboard / check428698: ' + check428698);
//      if (check428698) {
