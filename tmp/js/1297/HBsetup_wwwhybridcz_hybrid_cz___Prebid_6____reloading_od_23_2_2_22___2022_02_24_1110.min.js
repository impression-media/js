...
pbjs.adUnits = [];
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    checkReloadingAdsRestriction = 4 - (4 - imHbReloadingAds);
        ...
        var delId911216Mid428699 = document.querySelector("#cssId911216Mid428699") !== null;
        if (delId911216Mid428699) {
            document.querySelector('#cssId911216Mid428699').remove();
        }
    
    var cssId911216Mid428699 = document.createElement('style');
    cssId911216Mid428699.type ='text/css';
    cssId911216Mid428699.id ='cssId911216Mid428699';
    if(!!(window.attachEvent && !window.opera)) {
        cssId911216Mid428699.styleSheet.cssText ='#adform_square{width:300px; height:auto}';
    } else {
        var styleText911216Mid428699 = document.createTextNode('#adform_square{width:300px; height:auto}');
        cssId911216Mid428699.appendChild(styleText911216Mid428699);
    }
    document.getElementsByTagName('head')[0].appendChild(cssId911216Mid428699);
    if(checkReloadingAdsRestriction > 0){
