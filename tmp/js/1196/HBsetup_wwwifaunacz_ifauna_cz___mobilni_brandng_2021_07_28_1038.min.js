...
var bidderFloor = {"cpex-tt": 3,"criteo-im": 3,"adform-im-tt": 3,"cpex-nt": 3,"adform-im-nt": 3,"r2b2": 3,"stroeerCore": 5,"PubMatic": 3,"Teads": 3
};
var webFloor = 0.00;
var webResponzivitaRange ='desktop:1000::|mobil::999:';
var webBidders ='cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,stroeerCore,PubMatic,Teads';    
var placementFloor = {"adformsquare2": 0.00,"AdTrackGenericInterscrollerDesktop": 0.00,"adformMobilniBranding": 1.00,
};
var bidderAlias = {"cpex-tt":"rubicon","criteo-im":"criteo","adform-im-tt":"adform","cpex-nt":"rubicon","adform-im-nt":"adform","r2b2":"r2b2","stroeerCore":"stroeerCore","PubMatic":"pubmatic","Teads":"teads"};
var tierAlias = {"621020":"adform_square2","793338":"adform_interscroller","621026":"adform_mobilnibranding",
};
var responzivita = {"adform_square2":"desktop","AdTrackGenericInterscrollerDesktop":"mobil","adformMobilniBranding":"mobil",
};    
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_square2").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=621020"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id: 'wwwifaunacz-1-1196-910412',
            code: 'adform_square2',
                mediaTypes: {
                   banner: {sizes: [
...
//      var check621020 = document.querySelector("#adform_square2") !== null;
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#AdTrackGenericInterscrollerDesktop").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=793338"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id: 'wwwifaunacz-1-1196-910413',
...
//      var check793338 = document.querySelector("#AdTrackGenericInterscrollerDesktop") !== null;
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adformMobilniBranding").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=621026"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id: 'wwwifaunacz-1-1196-910414',
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "ifauna/Mobilnibranding_621026",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['adformMobilniBranding'] = '621026';
  
      }else{
//      var check621026 = document.querySelector("#adformMobilniBranding") !== null;
