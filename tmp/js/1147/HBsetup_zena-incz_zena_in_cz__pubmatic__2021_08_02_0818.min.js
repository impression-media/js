 ...
 * Last update: 02.08.2021 8:18:40
 * Ticket ID: ... / [1147]
 * Generated for WebSite: [https://zena-in.cz]
 * User ID: [1]    
 * Custom ticket name: [zena-in.cz (pubmatic)]
...
//            }
            ...
            newIndividualCss('.layout .layout-column-2 .main-top{display:none}.layout .layout-column-2 .main{position:relative; margin-top: 200px;}', 'imHbbrandingplus');
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1200)){
    ...
    var check910109 = document.querySelector("#brandingPlus") !== null;
    console.log('ID: brandingPlus / check910109: ' + check910109);
...
adUnits.push(
    ...
    "hbm_zone": {
        ...
        "slot_code": "/96856532/TT-Zena-in.cz-Branding-2000-1400-GAM",                 //unitSlotGAD
        ...
        "bids": [
            ...
            {                                                 //paramsAllBidders [;;;]
                ...
                "labelAny": ["desktop"],        
                    "params": {
                               mid: 830775,                        //int cislaOstatni // paramsAllBidders [@@@][::]    
                    }                
            },                                                  //explode paramsAllBidders (bidders) 
            {                                                 //paramsAllBidders [;;;]
                "bidder": "adform-im-nt",
                "labelAny": ["desktop"],        
                    "params": {
                               mid: 830776,                        //int cislaOstatni // paramsAllBidders [@@@][::]    
                    }                
            }
        ]
    },
...
// unitResponzivita:All
  if(((imHbWindowWidth >= 1) && (imHbWindowWidth <= 9999))){
    ...
    var check910107 = document.querySelector("#adform_leaderboard2") !== null;
    console.log('ID: adform_leaderboard2 / check910107: ' + check910107);
...
// unitResponzivita:All
  if(((imHbWindowWidth >= 1) && (imHbWindowWidth <= 9999))){
    ...
    var check910108 = document.querySelector("#adform_leaderboard") !== null;
    console.log('ID: adform_leaderboard / check910108: ' + check910108);
...
adUnits.push(
    ...
    "hbm_zone": {
        ...
        "nontracked": 0,                                             //unitSizeMapping
        "outofpage": 0,                                            //unitMinimalScreen
        "slot_code": "/96856532/TT-Zena-in.cz-CW-Leaderboard-1000-250-GAM",                 //unitSlotGAD
        "slot_sizes": [                                           //unitBannerSize
                [
                    1000,                                          //unitBannerSize
                    250                                           //unitBannerSize
        ...
        "bids": [
            ...
            {                                                 //paramsAllBidders [;;;]
                ...
                "labelAny": ["all"],        
                    "params": {
                               networkId: 7456,                        //int (criteo-im >> networkId) // paramsAllBidders [@@@][::]
                               publisherSubId: "zena-in/Leaderboard_830773",                        //varchar (criteo-im >> publisherSubId) // paramsAllBidders [@@@][::]    
                    }                
            },                                                  //explode paramsAllBidders (bidders) 
            {                                                 //paramsAllBidders [;;;]
                "bidder": "adform-im-tt",
                "labelAny": ["all"],        
                    "params": {
                               mid: 830773,                        //int cislaOstatni // paramsAllBidders [@@@][::]    
                    }                
            },                                                  //explode paramsAllBidders (bidders) 
            {                                                 //paramsAllBidders [;;;]
                "bidder": "adform-im-nt",
                "labelAny": ["all"],        
                    "params": {
                               mid: 830774,                        //int cislaOstatni // paramsAllBidders [@@@][::]    
                    }                
            }
        ]
    },
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1147&statistics=2&hbmasterscript='+hbmasterscript+'&data='+strData);
