...
var bidderFloor = {"cpex-tt": 3,"criteo-im": 3,"adform-im-tt": 3,"cpex-nt": 3,"adform-im-nt": 3,"r2b2": 3,"stroeerCore": 5,"adform-omd": 3,"PubMatic": 3,"Teads": 3
};
var webFloor = 0.00;
var webResponzivitaRange ='desktop:1000::|mobil::999:';
var webBidders ='cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,stroeerCore,PubMatic,Teads,adform-omd';    
var placementFloor = {"adformsquare2": 0.00,"AdTrackGenericInterscrollerDesktop": 0.00,
};
var bidderAlias = {"cpex-tt":"rubicon","criteo-im":"criteo","adform-im-tt":"adform","cpex-nt":"rubicon","adform-im-nt":"adform","r2b2":"r2b2","stroeerCore":"stroeerCore","adform-omd":"adform","PubMatic":"pubmatic","Teads":"teads"};
var tierAlias = {"621020":"adform_square2","793338":"adform_interscroller",
};
var responzivita = {"adform_square2":"desktop","AdTrackGenericInterscrollerDesktop":"mobil",
};    
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    checkReloadingAdsRestriction = 1; 
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            document.querySelector("#adform_square2").innerHTML ='<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript id=\'im-script-adform_square2\' src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=621020"></scr'+'ipt>'; 
            document.querySelector("#adform_square2").setAttribute('data-checkReloadingAdsRestriction','Ready as '+checkReloadingAdsRestriction+' from 0');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_square2").setAttribute('data-checkReloadingAdsRestriction','Stop as '+checkReloadingAdsRestriction+' from 0');
            }
        }
    }else{ 
...
function statisticsAuctionEnd(data, kam){
    ...
    xhr.open('GET','https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1264&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable.adform_square2 ='621020';
        }else{
        }    
        pbjs.adUnits.push(    
        {
            id:'wwwifaunacz-1-1264-910982',
            code:'adform_square2',
                mediaTypes: {
                   banner: {sizes: [
               [300,600],[300,300],[300,250],[160,600],[250,250],[120,600]
                   ]}
                ...
                {"bidder":"criteo-im","bidderCode":"criteo","params": {
                               networkId: 7456,
                               publisherSubId:"ifauna/Square_300x600_621020",    
                        }                
                },
                ...
                {"bidder":"stroeerCore","bidderCode":"stroeerCore","params": {
                               sid:"572d8cd6-11df-4031-b1f1-72a978dc736d",    
                        }                
                },
        ...
        } pbjs.WEURON_MapPositions.adform_square2 ='621020';
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable.AdTrackGenericInterscrollerDesktop ='793338';
        }else{
        }    
        pbjs.adUnits.push(    
        {
            id:'wwwifaunacz-1-1264-910983',
        ...
        if(typeof pbjs.WEURON_MapPositions  ==='undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions.AdTrackGenericInterscrollerDesktop ='793338';
