...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('adform_square2 : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        checkReloadingAdsRestriction = 1 - (15 - imHbReloadingAds);
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            ...
            document.querySelector("#adform_square2").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 1');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_square2").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 1');
            }
        }
    }else{ 
