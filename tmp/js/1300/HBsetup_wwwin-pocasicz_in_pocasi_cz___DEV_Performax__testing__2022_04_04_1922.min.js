...
//                    +"<div style=\"min-height:15; position:absolute; left:0px; top:-30px; z-index:100001; padding:0px 10px; background:white; color: grey; display:block; font-weight:normal; font-family:arial, sans-serif !important; font-size: 16px !important; text-shadow: none !important; line-height: 30px !important;\">"+reklamaImpressionMedia+"</div>" 
                    +"<div onclick=\"zavriReklamuBottomBoxWraperADF100p()\" style=\"border-top-left-radius:15px;width:auto;min-width:100px;cursor:pointer;min-height:30px; position:absolute; right:0px; top:-29px; z-index:100001; padding:0px 10px; background:rgba(0, 0, 0, 0.8);color: rgb(255,255,255); display:block; font-weight:normal; font-family:arial, sans-serif !important; font-size: 12px !important; text-shadow: none !important; line-height: 30px !important;\">"+zavritReklamuImpressionMedia+"</div>"            
                +"</div>";
