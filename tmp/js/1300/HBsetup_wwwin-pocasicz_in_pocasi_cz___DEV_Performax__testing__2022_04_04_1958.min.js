...
//                    +"<div id=\"textReklamaImpressionMedia\" style=\"min-height:15; position:absolute; left:0px; top:-30px; z-index:100001; padding:0px 10px; background:white; color: grey; display:block; font-weight:normal; font-family:arial, sans-serif !important; font-size: 16px !important; text-shadow: none !important; line-height: 30px !important;\">"+reklamaImpressionMedia+"</div>" 
        ...
        if(tmpStr !== null){
            ...
            if(tmpStr !== null){
                ...
                if (selection) {
                   ...
                   document.querySelector("#textReklamaImpressionMedia").remove();
                   document.querySelector("#adfContainerMobil").setAttribute("styl", "");
                   document.querySelector("#bottomBoxWraperADF100p").setAttribute("styl", "");
                }
                tmpStr = "jump";
