                ...
                if(ifrHeight > weuron.log.maxHeight){
                    ...
                    if(ifrHeight){
                        ...
                        if(imSirkaBody > Math.round(ifrWidth*imZoom)){
                            ...
                            var selection = document.querySelector("#responsiv-mobilBranding-iframe-ifrHeight0") !== null;
                            if (selection){document.querySelector("#responsiv-mobilBranding-iframe-ifrHeight0").remove()}
                            ...
                            if(ifrWidth){
                                ...
                                if(imSirkaBody<ifrWidth){
                                    ...
                                    var selection = document.querySelector("#responsiv-mobilBranding-iframe-ifrWidth0") !== null;
                                    if (selection){document.querySelector("#responsiv-mobilBranding-iframe-ifrWidth0").remove()}
                                    //document.getElementsByTagName("head")[0].appendChild(styleNode);
                                    document.body.appendChild(styleNode);
                                }
                    ...
                    if(ifrWidth){
                        ...
                        if(imSirkaBody<ifrWidth){
                            ...
                            var selection = document.querySelector("#responsiv-mobilBranding-iframe-ifrWidth1") !== null;
                            if (selection){document.querySelector("#responsiv-mobilBranding-iframe-ifrWidth1").remove()}
                            //document.getElementsByTagName("head")[0].appendChild(styleNode);
                            document.body.appendChild(styleNode);
                        }
        ...
        if(ifrHeight > weuron.log.maxHeight){
            ...
            if(ifrHeight){
                ...
                if(imSirkaBody > Math.round(ifrWidth*imZoom)){
                    ...
                    var selection = document.querySelector("#responsiv-mobilBranding-iframe-ifrHeight1") !== null;
                    if (selection){document.querySelector("#responsiv-mobilBranding-iframe-ifrHeight1").remove()}
                    //document.getElementsByTagName("head")[0].appendChild(styleNode);
                    document.body.appendChild(styleNode);
                    ...
                    if(ifrWidth){
                        ...
                        if(imSirkaBody<ifrWidth){
                            ...
                            var selection = document.querySelector("#responsiv-mobilBranding-iframe-ifrWidth2") !== null;
                            if (selection){document.querySelector("#responsiv-mobilBranding-iframe-ifrWidth2").remove()}
                            //document.getElementsByTagName("head")[0].appendChild(styleNode);
                            document.body.appendChild(styleNode);
                        }
            ...
            if(ifrWidth){
                ...
                if(imSirkaBody<ifrWidth){
                    ...
                    var selection = document.querySelector("#responsiv-mobilBranding-iframe-ifrWidth3") !== null;
                    if (selection){document.querySelector("#responsiv-mobilBranding-iframe-ifrWidth3").remove()}
                    //document.getElementsByTagName("head")[0].appendChild(styleNode);
                    document.body.appendChild(styleNode);
                }
