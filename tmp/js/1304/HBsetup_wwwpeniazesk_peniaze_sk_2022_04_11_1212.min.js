...
//  Web Variableexclude#@##@#
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    jsId911251Mid1394543.innerHTML = "var newEl= document.createElement('div');newEl.id = 'adform_square';newEl.innerHTML = '<sc'+'ript data-adfscript=\"adx.adform.net/adx/?mid=123456\"></sc'+'ript>';var imTarget = document.querySelector('#div-gpt-ad-1643291320590-0');imTarget.appendChild(newEl);console.log('im append adform_square')";
