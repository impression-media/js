 ...
 * Last update: 04.08.2023 18:44:06
 * Ticket ID: ... / [1657]
 * Generated for WebSite: [https://pisnicky-akordy.cz]
 * User ID: [1]    
 * Custom ticket name: [Pisnicky-akordy.cz + TEST (od 4.8.2023)]
...
// unitResponzivita:branding
  if((imHbWindowWidth >= 1200)){
    ...
    var check913764 = document.querySelector("#brandingPlus") !== null;
    console.log('ID: brandingPlus / check913764: ' + check913764);
...
// unitResponzivita:All
  if(((imHbWindowWidth >= 1) && (imHbWindowWidth <= 9999))){
    ...
    var check913766 = document.querySelector("#adform_square") !== null;
    console.log('ID: adform_square / check913766: ' + check913766);
    ...
    "hbm_zone": {
        ...
        "bids": [
            ...
            {                                                 //paramsAllBidders [;;;]
                ...
                "labelAny": ["all"],        
                    "params": {
                               pageId: "123503",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]
                               placementId: "134209",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]    
                    }                
            },                                                  //explode paramsAllBidders (bidders) 
            {                                                 //paramsAllBidders [;;;]
                "bidder": "adform-omd",
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1000)){
    ...
    var check913765 = document.querySelector("#adform_leaderboard") !== null;
    console.log('ID: adform_leaderboard / check913765: ' + check913765);
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1657&statistics=1&groupBidsReceivedTable=4&groupRandId=0&hbmasterscript='+hbmasterscript+'&data='+strData);
