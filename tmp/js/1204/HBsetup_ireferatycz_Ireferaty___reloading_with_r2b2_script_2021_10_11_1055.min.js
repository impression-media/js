 ...
 * Last update: 11.10.2021  10:55
 * Generated for WebSite: [https://ireferaty.cz] 
 * Custom ticket name: [Ireferaty - reloading with r2b2 script]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1204]
 * User ID: [1]    
...
var responzivita = { 
    ...
    "square-ir": "all",
    "top-leaderboard-vse": "tablet,mobil",
...
if(imHbMbIsMobile.any()){ 
    ...
    var selection = top.document.querySelector("#"+weuron.log.dividStrip) !== null;
    if (selection) {
       top.document.querySelector("#"+weuron.log.dividStrip).remove();
    }
}else{
    console.log("else imHbMbIsMobile >> PC");
    var imStripContent = "<span style=\"display:none\">Strip DIV ID notSet</span>";

    var selection = top.document.body.getAttribute("data-desktopStrip-reloadingAds") !== null;
    if (selection) {
        weuron.log.cappingReloadingAds = top.document.body.getAttribute("data-desktopStrip-reloadingAds");    
    }else{
        weuron.log.cappingReloadingAds = "ready";
        top.document.body.setAttribute("data-desktopStrip-reloadingAds", "ready");         
    }
    ...
    if(weuron.log.cappingDS !== "notSet"){
        if(weuron.log.cappingReloadingAds === "ready"){
            ...
            if(imCappingDS == null){
                ...
                if(weuron.log.reloadingAds > 0){
                    top.document.body.setAttribute("data-desktopStrip-firstCyklusReloading", "firstCyklusReloadingAds");                 
                    if(weuron.log.forbiddenReloadingAdsInDsCapping){ 
                        top.document.body.setAttribute("data-desktopStrip-reloadingAds", "noReloadingAds");                       
                    }else{
                ...
                if(weuron.log.reloadingAds > 0){
                    ...
                    if(weuron.log.cappingReloadingAds == "ready"){
                        if(imAllowReloadingAdsInDsCapping != null){
                            var selection = top.document.body.getAttribute("data-desktopStrip-firstCyklusReloading") !== null;
                            if (selection) {
                                var imCappingStopDS = "NE";
                                top.document.body.setAttribute("data-desktopStrip-firstCyklusReloading", "completed");
                            }else{
    ...
    if(imCappingStopDS == "NE"){
        ...
        var selection = top.document.querySelector("#imDesktopStrip") !== null;
        if (selection) {
           top.document.querySelector("#imDesktopStrip").remove();
        }
         ...
         if (selection) {
            ...
            console.log(top.document.querySelector("#"+weuron.log.dividStrip).innerHTML); 
            var divIdInnerHtml = top.document.querySelector("#"+weuron.log.dividStrip).innerHTML;
            top.document.querySelector("#"+weuron.log.dividStrip).remove();
        ...
        var selection = top.document.querySelector("#"+weuron.log.dividDS) !== null;
        if (selection) {
            top.document.querySelector("#"+weuron.log.dividDS).remove();
        }
        var selection = top.document.querySelector("#imDesktopStrip") !== null;
        if (selection) {
            top.document.querySelector("#imDesktopStrip").remove();
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank;
    ...
    if((pbjs.WEURON_WindowWidth >= 1200)){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#top-leaderboard-vse").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=453517"></scr'+'ipt>'; 
        }
    }else{ 
    ...
    console.log('top-leaderboard-vse : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
        ...
        if (checkReloadingAdsRestriction < 0) {
            ...
            if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
                document.querySelector('#top-leaderboard-vse').innerHTML = '<span style=\'display:none !important\'>All was removed - checkReloadingAdsRestriction < 0</span>';
           }
        }
    if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#square-ir").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=453521"></scr'+'ipt>'; 
        }
    }else{ 
    ...
    console.log('square-ir : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
        ...
        if (checkReloadingAdsRestriction < 0) {
            ...
            console.log('ID: square-ir / MID:453521 / DIV ID found: ' + nonResponsiveLeaveBlank);
            if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
                document.querySelector('#square-ir').innerHTML = '<span style=\'display:none !important\'>All was removed - checkReloadingAdsRestriction < 0</span>';
           }
        }
    if(((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199)) || (pbjs.WEURON_WindowWidth <= 767)){
        responsiveConditionReady = document.querySelector("#top-leaderboard-vse") !== null;
        console.log('ID: top-leaderboard-vse / MID:614447 / DIV ID found: ' + responsiveConditionReady);
        if (responsiveConditionReady) {    
            document.querySelector("#top-leaderboard-vse").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=614447"></scr'+'ipt>'; 
        }
    }else{ 
        nonResponsiveLeaveBlank = document.querySelector("#top-leaderboard-vse") !== null;
    ...
    if((pbjs.WEURON_WindowWidth >= 1200)){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#bottom-leaderboard-desktop").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=453518"></scr'+'ipt>'; 
        }
    }else{ 
    ...
    console.log('bottom-leaderboard-desktop : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
    ...
    if(((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199)) || (pbjs.WEURON_WindowWidth <= 767)){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#bottom-leaderboard-mobil").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=614449"></scr'+'ipt>'; 
        }
    }else{ 
    ...
    console.log('bottom-leaderboard-mobil : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
    ...
    if((pbjs.WEURON_WindowWidth >= 1200)){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#podClanek-desktop").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=453520"></scr'+'ipt>'; 
        }
    }else{ 
    ...
    console.log('podClanek-desktop : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
        ...
        if (checkReloadingAdsRestriction < 0) {
            ...
            console.log('ID: podClanek-desktop / MID:453520 / DIV ID found: ' + nonResponsiveLeaveBlank);
            if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
                document.querySelector('#podClanek-desktop').innerHTML = '<span style=\'display:none !important\'>All was removed - checkReloadingAdsRestriction < 0</span>';
           }
        }
    if(((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199)) || (pbjs.WEURON_WindowWidth <= 767)){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#podClanek-mobil").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=614450"></scr'+'ipt>'; 
        }
    }else{ 
    ...
    console.log('podClanek-mobil : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
        ...
        if (checkReloadingAdsRestriction < 0) {
            ...
            console.log('ID: podClanek-mobil / MID:614450 / DIV ID found: ' + nonResponsiveLeaveBlank);
            if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
                document.querySelector('#podClanek-mobil').innerHTML = '<span style=\'display:none !important\'>All was removed - checkReloadingAdsRestriction < 0</span>';
           }
        }
    if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#adformMobilniBranding").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=453516"></scr'+'ipt>'; 
        }
    }else{ 
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
    ...
    if((pbjs.WEURON_WindowWidth >= 1000)){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#adformDesktopStrip").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=938107"></scr'+'ipt>'; 
        }
    }else{ 
    ...
    console.log('adformDesktopStrip : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
        ...
        if (checkReloadingAdsRestriction < 0) {
            ...
            console.log('ID: adformDesktopStrip / MID:938107 / DIV ID found: ' + nonResponsiveLeaveBlank);
            if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
                document.querySelector('#adformDesktopStrip').innerHTML = '<span style=\'display:none !important\'>All was removed - checkReloadingAdsRestriction < 0</span>';
           }
        }
//if(imHbReloadingAds == '3'){
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1204&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
...
console.log('no URL condition');
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
    checkReloadingAdsRestriction = 1000 - (3 - imHbReloadingAds);
...
//          "refresh_limit": 0,        
        ...
        console.log('Remove / Responzivita = FALSE >> Placement / MID: top-leaderboard-vse / 614447  (' + pbjs.WEURON_WindowWidth + ')');
