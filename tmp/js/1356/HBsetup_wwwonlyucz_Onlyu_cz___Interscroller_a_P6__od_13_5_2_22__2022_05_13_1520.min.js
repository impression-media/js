...
var bidderFloor = {"criteo-im": 3,"adform-im-tt": 3,"adform-im-nt": 3,"r2b2": 3,"appnexus": 3,"adform-omd": 3
};
var webFloor = 0.00;
var webResponzivitaRange ='mobil::999:|desktop:1000::';
var webBidders ='criteo-im,adform-im-tt,adform-im-nt,r2b2,appnexus,adform-omd';    
var placementFloor = {"adformMobilniBranding": 1.00,"adformhalfpage": 0.00,"AdTrackGenericInterscrollerDesktop": 0.00,
};
var bidderAlias = {"criteo-im":"criteo","adform-im-tt":"adform","adform-im-nt":"adform","r2b2":"r2b2","appnexus":"appnexus","adform-omd":"adform"};
var tierAlias = {"852736":"adform_mobilnibranding","852581":"adform_halfpage","852832":"adform_interscroller",
};
var responzivita = {"adformMobilniBranding":"mobil","adform_halfpage":"desktop","AdTrackGenericInterscrollerDesktop":"mobil",
};    
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1356&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable.adformMobilniBranding = '852736';
        }else{
        }    
        pbjs.adUnits.push(    
        {
            id: 'wwwonlyucz-1-1356-911630',
            code: 'adformMobilniBranding',
                mediaTypes: {
                   banner: {sizes: [
               [320,50],[320,150],[300,100],[300,50],[300,300],[300,250],[336,280],[250,250],[300,150],[480,300],[970,350],[970,250],[970,210],[970,90],[970,310],[728,90],[300,120],[500,200],[320,100],[320,100],[320,100]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
            
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "onlyu/Mobilnibranding_852736",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        } pbjs.WEURON_MapPositions.adformMobilniBranding = '852736';
  
      }else{
//      var check852736 = document.querySelector("#adformMobilniBranding") !== null;
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable.adform_halfpage = '852581';
        }else{
        }    
        pbjs.adUnits.push(    
        {
            id: 'wwwonlyucz-1-1356-911631',
            code: 'adform_halfpage',
                mediaTypes: {
                   banner: {sizes: [
               [300,600],[300,300],[300,250],[250,250],[120,600],[160,600]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "onlyu/Square_300x600_1_852581",    
                        }                
                },
                {
                    "bidder": "r2b2",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions.adform_halfpage = '852581';
  
      }else{
//      var check852581 = document.querySelector("#adform_halfpage") !== null;
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable.AdTrackGenericInterscrollerDesktop = '852832';
        }else{
        }    
        pbjs.adUnits.push(    
        {
            id: 'wwwonlyucz-1-1356-911632',
...
//          "refresh_limit": 0,        
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions.AdTrackGenericInterscrollerDesktop = '852832';
  
      }else{
//      var check852832 = document.querySelector("#AdTrackGenericInterscrollerDesktop") !== null;
