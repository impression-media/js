...
if(weuron.log.dev !=="notSet"){
    ...
    var selection = top.document.querySelector("[data-google-interstitial='false']") !== null;
    if (selection) {
        top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ok-1");
        const imR2b2cboxes = document.querySelectorAll("[data-google-interstitial='false']");

        for (let i = 0; i < imR2b2cboxes.length; i++) {
            imR2b2cboxes[i].addEventListener("click", function() {
                var imR2b2WrapperId = imR2b2cboxes[i].parentNode.parentNode.parentNode.parentNode.parentNode.id;
                if(imR2b2WrapperId.startsWith("sssp-zone")){
                    var selection = top.document.querySelector("#"+imR2b2WrapperId) !== null;
                    if (selection) {
                        document.getElementById(""+imR2b2WrapperId).remove();
                    }
                }
                weuron.log.closeMbCappingPageBrowsing = 1;
                zavriReklamuBottomBoxWraperADF100p();
        ...
        top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ko-1");
        setTimeout(function(){
            var selection = top.document.querySelector("[data-google-interstitial='false']") !== null;
            if (selection) {
                top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ok-2");
                const imR2b2cboxes = document.querySelectorAll("[data-google-interstitial='false']");
                ...
                top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ko-2");
                setTimeout(function(){
                    var selection = top.document.querySelector("[data-google-interstitial='false']") !== null;
                    if (selection) {
                        top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ok-3");
                        const imR2b2cboxes = document.querySelectorAll("[data-google-interstitial='false']");
                        ...
                        top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ko-3");
                        setTimeout(function(){
                            var selection = top.document.querySelector("[data-google-interstitial='false']") !== null;
                            if (selection) {
                                top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ok-4");
                                const imR2b2cboxes = document.querySelectorAll("[data-google-interstitial='false']");
                                ...
                                top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ko-4");
                                setTimeout(function(){
                                    var selection = top.document.querySelector("[data-google-interstitial='false']") !== null;
                                    if (selection) {
                                       top.document.body.setAttribute("data-mobilniBranding-r2b2Check", "ok-5");
                                        const imR2b2cboxes = document.querySelectorAll("[data-google-interstitial='false']");
...
if(typeof s !=='undefined'){ 
    ...
    if (compareInfo) {
        ...
        compareInfo.innerHTML ='<br> hbkey: hb-'+ e
        ...
        var n = function(t) {
            if (pbjs.IMPRESSION_SkinCPM && pbjs.CPEx_skinExcludePositions && void 0 !== pbjs.CPEx_skinExcludePositions[s] && pbjs.CPEx_skinExcludePositions[s] <= pbjs.IMPRESSION_SkinCPM) {
              ...
              ?(
                ...
                adformtag.setTargeting(s,"hbreloaing", -1) 
              ): 
                (
