...
var checkReloadingAdsRestriction; 
    ...
    console.log('notSet : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 2' + '' );
    checkReloadingAdsRestriction = 1000 - (2 - imHbReloadingAds);
    
    console.log('imHbReloadingAds:: '+imHbReloadingAds);
    console.log('imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction); 
    if (checkReloadingAdsRestriction < 0) {
        console.log('notSet : REMOVE imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);     
        nonResponsiveLeaveBlank = document.querySelector("#notSet") !== null;
        console.log('ID: notSet / MID:453516 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) { //cela podminka puvodne v DEV modu zakomnetovana
            document.querySelector("#notSet").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    console.log('PROD >> imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#notSet") !== null;
        console.log('ID: notSet / hbPlacement453516: ' + hbPlacement);
        if (hbPlacement) {
            if(!imHbPlacementEnable.includes('notSet')){
                imHbPlacementEnable.push('notSet');
            }
            imHbAsocPlacementMidEnable['notSet'] = '453516';
        }

        console.log('Responzivita = TRUE >> Placement / MID: notSet / 453516  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
...
//          "refresh_limit": 0,        
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions['notSet'] = '453516';
  
      }else{
        console.log('Responzivita = FALSE >> Placement / MID: notSet / 453516  (' + pbjs.WEURON_WindowWidth + ')');
//      var check453516 = document.querySelector("#notSet") !== null;
//      console.log('ID: notSet / check453516: ' + check453516);
//      if (check453516) {
//          document.querySelector("#notSet").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
