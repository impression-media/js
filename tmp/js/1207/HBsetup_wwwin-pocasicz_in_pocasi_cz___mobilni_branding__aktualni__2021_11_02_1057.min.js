...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    if((pbjs.WEURON_WindowWidth >= 1000)){
        ...
        setTimeout(function(){
            var imMinHeight910507 = document.querySelector("#adform_leaderboard iframe").style.height;
            //document.querySelector("#adform_leaderboard").setAttribute('im-min-height', imMinHeight910507);
            if(imMinHeight910507 == '1400px'){
                ...
                document.querySelector("#adform_leaderboard").style.minHeight = imMinHeight910507;
            }
        }, 15000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth >= 1000)){
        ...
        setTimeout(function(){
            var imMinHeight910508 = document.querySelector("#adform_square iframe").style.height;
            //document.querySelector("#adform_square").setAttribute('im-min-height', imMinHeight910508);
            if(imMinHeight910508 == '1400px'){
                document.querySelector("#adform_square").style.minHeight = '0px';
                document.querySelector("#adform_square iframe").style.display = 'none';
            }else{
                document.querySelector("#adform_square").style.minHeight = imMinHeight910508;
            }
        }, 15000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth >= 1000)){
        ...
        setTimeout(function(){
            var imMinHeight910509 = document.querySelector("#adform_square2 iframe").style.height;
            //document.querySelector("#adform_square2").setAttribute('im-min-height', imMinHeight910509);
            if(imMinHeight910509 == '1400px'){
                document.querySelector("#adform_square2").style.minHeight = '0px';
                document.querySelector("#adform_square2 iframe").style.display = 'none';
            }else{
                document.querySelector("#adform_square2").style.minHeight = imMinHeight910509;
            }
        }, 15000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 999)){
        ...
        setTimeout(function(){
            var imMinHeight910510 = document.querySelector("#AdTrackGenericInterscrollerDesktop iframe").style.height;
            //document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('im-min-height', imMinHeight910510);
            if(imMinHeight910510 == '1400px'){
                ...
                document.querySelector("#AdTrackGenericInterscrollerDesktop").style.minHeight = imMinHeight910510;
            }
        }, 15000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 999)){
        ...
        setTimeout(function(){
            var imMinHeight910511 = document.querySelector("#adformMobilniBranding iframe").style.height;
            //document.querySelector("#adformMobilniBranding").setAttribute('im-min-height', imMinHeight910511);
            if(imMinHeight910511 == '1400px'){
                ...
                document.querySelector("#adformMobilniBranding").style.minHeight = imMinHeight910511;
            }
        }, 15000);
        }
    }else{ 
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1207&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){ 
        ...
        var remId910507Mid428711 = document.querySelector("#jsId910507Mid428711") !== null;
        if (remId910507Mid428711) {
            document.querySelector('#jsId910507Mid428711').remove();
        }
    
    var jsId910507Mid428711 = document.createElement('script');
    jsId910507Mid428711.type = 'text/javascript';
    jsId910507Mid428711.id = 'jsId910507Mid428711';
    jsId910507Mid428711.innerHTML = "var selection = top.document.querySelector('body') !== null;if (selection) {top.document.body.style.marginTop ='0px'}";
    document.body.appendChild(jsId910507Mid428711);
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1207-910507',
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1207-910508',
            code: 'adform_square',
                mediaTypes: {
                   banner: {sizes: [
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1207-910509',
            code: 'adform_square2',
                mediaTypes: {
                   banner: {sizes: [
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1207-910510',
...
//      }
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1207-910511',
