...
var bidderFloor = {"cpex-tt": 3,"criteo-im": 3,"adform-im-tt": 3,"cpex-nt": 3,"adform-im-nt": 3,"r2b2": 3,"appnexus": 3,"adform-omd": 3
};
var webFloor = 0.00;
...
var placementFloor = {"adformMobilniBranding": 1.00,
};
var bidderAlias = {"cpex-tt":"rubicon","criteo-im":"criteo","adform-im-tt":"adform","cpex-nt":"rubicon","adform-im-nt":"adform","r2b2":"r2b2","appnexus":"appnexus","adform-omd":"adform"};
var tierAlias = {"1076987":"adform_mobilnibranding",
};
var responzivita = {"adformMobilniBranding":"mobil",
};    
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1341&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable.adformMobilniBranding = '1076987';
        }else{
        }    
        pbjs.adUnits.push(    
        {
            id: 'wwwtvojechvilkacz-1-1341-911548',
            code: 'adformMobilniBranding',
                mediaTypes: {
                   banner: {sizes: [
               [320,50],[320,150],[300,100],[300,50],[300,300],[300,250],[336,280],[250,250],[300,150],[480,300],[970,350],[970,250],[970,210],[970,90],[970,310],[728,90],[300,120],[500,200],[320,100]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "tvojechvilka/Mobilnibranding_1076987",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        } pbjs.WEURON_MapPositions.adformMobilniBranding = '1076987';
  
      }else{
//      var check1076987 = document.querySelector("#adformMobilniBranding") !== null;
