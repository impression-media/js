...
var placementFloor = {"adformsquare": 0.00,"adformleaderboard": 0.00,"adformleaderboard": 0.00,
};
...
var tierAlias = {"428699":"adform_square","428698":"adform_leaderboard","428698":"adform_leaderboard",
};
var responzivita = {"adform_square":"ALL","adform_leaderboard":"vcetneBrandingu","adform_leaderboard":"bezBrandingu",
};    
...
pbjs.adUnits = [];
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 1359))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id:'wwwhybridcz-1-1202-910466',
            code:'adform_leaderboard',
                mediaTypes: {
                   banner: {sizes: [
               [970,210],[970,90],[970,100],[970,200],[920,200],[930,180],[960,100],[900,200],[750,200],[750,100],[745,200],[745,100],[728,90],[468,60]
                   ]}
