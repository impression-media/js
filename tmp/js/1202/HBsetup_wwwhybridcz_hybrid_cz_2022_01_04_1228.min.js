...
function statisticsAuctionEnd(data, kam){
    ...
    xhr.open('GET','https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1202&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
...
pbjs.adUnits = [];
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_square").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=428699"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'wwwhybridcz-1-1202-910464',
            code:'adform_square',
                mediaTypes: {
                   banner: {sizes: [
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_leaderboard").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=428698"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'wwwhybridcz-1-1202-910465',
