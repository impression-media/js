 ...
 * Last update: 12.10.2021  13:52
 * Generated for WebSite: [https://ireferaty.cz] 
 * Custom ticket name: [Iframe Wrapper]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1206]
 * User ID: [1]    
...
var webBidders = 'cpex-tt,criteo-im,adform-im-tt,adform-im-nt,r2b2,appnexus,PubMatic,adform-im-tt_id_2';    
var placementFloor = { 
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('bottom-leaderboard-desktop : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910498 = document.querySelector("#bottom-leaderboard-desktop iframe").style.height;
            //document.querySelector("#bottom-leaderboard-desktop").setAttribute('im-min-height', imMinHeight910498); 
            document.querySelector("#bottom-leaderboard-desktop").style.minHeight = imMinHeight910498;
        }, 15000);
        }
    }else{ 
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1206&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
