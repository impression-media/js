...
function statisticsAuctionEnd(data, kam){
    ...
    xhr.open('GET','https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1195&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
