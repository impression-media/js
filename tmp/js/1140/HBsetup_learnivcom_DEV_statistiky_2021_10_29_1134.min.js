 ...
 * Last update: 29.10.2021 11:34:47
 * Ticket ID: ... / [1140]
 * Generated for WebSite: [https://learniv.com]
 * User ID: [1]    
 * Custom ticket name: [DEV statistiky]
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910059 = document.querySelector("#new-rectangle-desktop") !== null;
    console.log('ID: new-rectangle-desktop / check910059: ' + check910059);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910505 = document.querySelector("#new-square-mobil-1") !== null;
    console.log('ID: new-square-mobil-1 / check910505: ' + check910505);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910506 = document.querySelector("#new_square_pc-2") !== null;
    console.log('ID: new_square_pc-2 / check910506: ' + check910506);
...
// unitResponzivita:all
  if(((imHbWindowWidth >= 1) && (imHbWindowWidth <= 9999))){
    ...
    var check910062 = document.querySelector("#square") !== null;
    console.log('ID: square / check910062: ' + check910062);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910057 = document.querySelector("#learniv-300x600") !== null;
    console.log('ID: learniv-300x600 / check910057: ' + check910057);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910063 = document.querySelector("#nobranding") !== null;
    console.log('ID: nobranding / check910063: ' + check910063);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910056 = document.querySelector("#patickovy-leaderboard-mobil") !== null;
    console.log('ID: patickovy-leaderboard-mobil / check910056: ' + check910056);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910058 = document.querySelector("#patickovy-leaderboard-desktop") !== null;
    console.log('ID: patickovy-leaderboard-desktop / check910058: ' + check910058);
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1140&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
