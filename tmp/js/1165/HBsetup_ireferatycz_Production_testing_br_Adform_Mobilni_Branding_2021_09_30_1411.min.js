 ...
 * Last update: 30.09.2021  14:11
 * Generated for WebSite: [https://ireferaty.cz] 
 * Custom ticket name: [Production testing<br>Adform Mobilni Branding]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1165]
 * User ID: [1]    
...
var webBidders = 'cpex-tt,adform-im-tt,cpex-nt,appnexus,PubMatic,criteo-im,adform-im-nt,r2b2,Teads';    
var placementFloor = { 
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank;
    ...
    if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#im-mobilni_branding").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src="//s1.adform.net/banners/scripts/adx.js" data-adfscript="adx.adform.net/adx/?mid=453516"></scr'+'ipt>'; 
        }
    }else{ 
