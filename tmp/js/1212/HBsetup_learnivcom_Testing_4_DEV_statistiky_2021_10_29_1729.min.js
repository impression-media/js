 ...
 * Last update: 29.10.2021 17:29:51
 * Ticket ID: ... / [1212]
 * Generated for WebSite: [https://learniv.com]
 * User ID: [1]    
 * Custom ticket name: [Testing 4 DEV statistiky]
 * Project date: 23.8.2019 by Weuron s.r.o. 
*/

var dcs = document.currentScript.src;
if (/jsdelivr/i.test(dcs)){ var imCDN = 1; }else{ var imCDN = 0; }
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910557 = document.querySelector("#new-rectangle-desktop") !== null;
    console.log('ID: new-rectangle-desktop / check910557: ' + check910557);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910563 = document.querySelector("#new-square-mobil-1") !== null;
    console.log('ID: new-square-mobil-1 / check910563: ' + check910563);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910564 = document.querySelector("#new_square_pc-2") !== null;
    console.log('ID: new_square_pc-2 / check910564: ' + check910564);
...
// unitResponzivita:all
  if(((imHbWindowWidth >= 1) && (imHbWindowWidth <= 9999))){
    ...
    var check910560 = document.querySelector("#square") !== null;
    console.log('ID: square / check910560: ' + check910560);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910555 = document.querySelector("#learniv-300x600") !== null;
    console.log('ID: learniv-300x600 / check910555: ' + check910555);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910561 = document.querySelector("#nobranding") !== null;
    console.log('ID: nobranding / check910561: ' + check910561);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910554 = document.querySelector("#patickovy-leaderboard-mobil") !== null;
    console.log('ID: patickovy-leaderboard-mobil / check910554: ' + check910554);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910556 = document.querySelector("#patickovy-leaderboard-desktop") !== null;
    console.log('ID: patickovy-leaderboard-desktop / check910556: ' + check910556);
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1212&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
