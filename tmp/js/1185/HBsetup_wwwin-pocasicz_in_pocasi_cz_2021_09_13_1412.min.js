...
function statisticsAuctionEnd(data, kam){
    ...
    xhr.open('GET','https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1185&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
...
pbjs.adUnits = [];
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id:'wwwin-pocasicz-1-1185-910346',
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id:'wwwin-pocasicz-1-1185-910347',
            code:'adform_square',
                mediaTypes: {
                   banner: {sizes: [
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id:'wwwin-pocasicz-1-1185-910348',
            code:'adform_square2',
                mediaTypes: {
                   banner: {sizes: [
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id:'wwwin-pocasicz-1-1185-910349',
