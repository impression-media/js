...
if(((pbjs.WEURON_WindowWidth >= 1360) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if (responsiveConditionReady) {    
        document.querySelector("#adform_leaderboard-branding").innerHTML ='<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span>'; 
    }
}else{ 
...
if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if (responsiveConditionReady) {    
        document.querySelector("#adform_leaderboard2").innerHTML ='<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span>'; 
    }
}else{ 
...
if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if (responsiveConditionReady) {    
        document.querySelector("#adform_square").innerHTML ='<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span>'; 
    }
}else{ 
...
if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if (responsiveConditionReady) {    
        document.querySelector("#adform_square3").innerHTML ='<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span>'; 
    }
}else{ 
...
if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 1359))){
    ...
    if (responsiveConditionReady) {    
        document.querySelector("#adform_leaderboard").innerHTML ='<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span>'; 
    }
}else{ 
...
pbjs.adUnits = [];
  ...
  if(((pbjs.WEURON_WindowWidth >= 1360) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_leaderboard-branding").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=826052"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_leaderboard2").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=747178"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_square").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=747127"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_square3").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=747194"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 1359))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_leaderboard").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=747120"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
