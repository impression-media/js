 ...
 * Last update: 14.10.2021  12:05
 * Generated for WebSite: [https://www.in-pocasi.cz] 
 * Custom ticket name: [in-pocasi.cz + mobilni branding]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1197]
 * User ID: [1]    
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910415 = document.querySelector("#adform_leaderboard iframe").style.height;
            //document.querySelector("#adform_leaderboard").setAttribute('im-min-height', imMinHeight910415); 
            console.log('set imMinHeight >> imMinHeight910415: '+imMinHeight910415);
            if(imMinHeight910415 == '1400px'){
                ...
                document.querySelector("#adform_leaderboard").style.minHeight = imMinHeight910415;
            }
        }, 15000);
        }
    }else{ 
    ...
    console.log('adform_square : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910416 = document.querySelector("#adform_square iframe").style.height;
            //document.querySelector("#adform_square").setAttribute('im-min-height', imMinHeight910416); 
            console.log('set imMinHeight >> imMinHeight910416: '+imMinHeight910416);
            if(imMinHeight910416 == '1400px'){
                document.querySelector("#adform_square").style.minHeight = '0px';
                document.querySelector("#adform_square iframe").style.display = 'none';
            }else{
                document.querySelector("#adform_square").style.minHeight = imMinHeight910416;
            }
        }, 15000);
        }
    }else{ 
    ...
    console.log('adform_square2 : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910417 = document.querySelector("#adform_square2 iframe").style.height;
            //document.querySelector("#adform_square2").setAttribute('im-min-height', imMinHeight910417); 
            console.log('set imMinHeight >> imMinHeight910417: '+imMinHeight910417);
            if(imMinHeight910417 == '1400px'){
                document.querySelector("#adform_square2").style.minHeight = '0px';
                document.querySelector("#adform_square2 iframe").style.display = 'none';
            }else{
                document.querySelector("#adform_square2").style.minHeight = imMinHeight910417;
            }
        }, 15000);
        }
    }else{ 
    ...
    console.log('AdTrackGenericInterscrollerDesktop : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910418 = document.querySelector("#AdTrackGenericInterscrollerDesktop iframe").style.height;
            //document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('im-min-height', imMinHeight910418); 
            console.log('set imMinHeight >> imMinHeight910418: '+imMinHeight910418);
            if(imMinHeight910418 == '1400px'){
                ...
                document.querySelector("#AdTrackGenericInterscrollerDesktop").style.minHeight = imMinHeight910418;
            }
        }, 15000);
        }
    }else{ 
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 15 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        setTimeout(function(){
            var imMinHeight910419 = document.querySelector("#adformMobilniBranding iframe").style.height;
            //document.querySelector("#adformMobilniBranding").setAttribute('im-min-height', imMinHeight910419); 
            console.log('set imMinHeight >> imMinHeight910419: '+imMinHeight910419);
            if(imMinHeight910419 == '1400px'){
                ...
                document.querySelector("#adformMobilniBranding").style.minHeight = imMinHeight910419;
            }
        }, 15000);
        }
    }else{ 
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1197&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1197-910415',
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1197-910416',
            code: 'adform_square',
                mediaTypes: {
                   banner: {sizes: [
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1197-910417',
            code: 'adform_square2',
                mediaTypes: {
                   banner: {sizes: [
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1197-910418',
...
//      }
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1197-910419',
