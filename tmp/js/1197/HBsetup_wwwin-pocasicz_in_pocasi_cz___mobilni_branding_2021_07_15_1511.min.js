...
var webBidders ='cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,stroeerCore,PubMatic,Teads,r2b2_id_2';    
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_leaderboard").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=428711"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_square").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=428712"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adform_square2").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=938108"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#AdTrackGenericInterscrollerDesktop").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=686080"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adformMobilniBranding").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=447740"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
