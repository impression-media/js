 ...
 * Last update: 16.06.2022 18:07:46
 * Ticket ID: ... / [1371]
 * Generated for WebSite: [https://zena-in.cz]
 * User ID: [1]    
 * Custom ticket name: [zena-in.cz - P6 TEST]
...
var PREBID_TIMEOUT = 3500; // ms
var FAILSAFE_TIMEOUT = 3500; // ms
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1371&statistics=1&groupBidsReceivedTable=4&groupRandId=4&hbmasterscript='+hbmasterscript+'&data='+strData);
