...
var checkReloadingAdsRestriction;
    ...
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#leaderboard-2-desktop").innerHTML ='<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 1; 
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#footer-leaderboard-desktop").innerHTML ='<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 1; 
    if (checkReloadingAdsRestriction > 0) {     
    ...
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#leaderboard-2-mobil").innerHTML ='<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 1; 
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#footer-leaderboard-mobil").innerHTML ='<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 1; 
    if (checkReloadingAdsRestriction > 0) {     
...
function statisticsAuctionEnd(data, kam){
    ...
    xhr.open('GET','https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1170&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
