...
var placementFloor = {"adformleaderboard": 0.00,"adformrectangle": 0.00,"adformskyscraper": 0.00,"adformrectangle2": 13.00,"adformleaderboard2": 0.00,"adformrectanglem2": 0.00,"adformrectanglem": 7.00,"adformrectanglem3": 0.00,"adformrectanglem4": 0.00,"adformrectanglem5": 0.00,"clonadformrectanglem5": 0.00,
};
...
var responzivita = {"adform_leaderboard":"desktop","adform_rectangle":"desktop","adform_skyscraper":"desktop","adform_rectangle2":"desktop","adform_leaderboard2":"desktop","adform_rectanglem2":"mobil","adform_rectanglem":"mobil","adform_rectanglem3":"mobil","adform_rectanglem4":"mobil","adform_rectanglem5":"mobil","clon_adform_rectanglem5":"mobil",
};    
...
pbjs.adUnits = [];
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    checkReloadingAdsRestriction = 1;
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#clon_adform_rectanglem5") !== null;
        if (hbPlacement) {
            document.querySelector("#clon_adform_rectanglem5").innerHTML ='<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1090738"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id:'wwwextracz-1-1198-910452',
            code:'clon_adform_rectanglem5',
                mediaTypes: {
                   banner: {sizes: [
               [300,300],[300,250]
                   ]}
        ...
        if(typeof pbjs.WEURON_MapPositions  ==='undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['clon_adform_rectanglem5'] ='1090738';
