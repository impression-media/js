 ...
 * Last update: 29.10.2021 19:10:21
 * Ticket ID: ... / [1213]
 * Generated for WebSite: [https://learniv.com]
 * User ID: [1]    
 * Custom ticket name: [Testing 5 DEV statistiky]
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910568 = document.querySelector("#new-rectangle-desktop") !== null;
    console.log('ID: new-rectangle-desktop / check910568: ' + check910568);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910574 = document.querySelector("#new-square-mobil-1") !== null;
    console.log('ID: new-square-mobil-1 / check910574: ' + check910574);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910575 = document.querySelector("#new_square_pc-2") !== null;
    console.log('ID: new_square_pc-2 / check910575: ' + check910575);
...
// unitResponzivita:all
  if(((imHbWindowWidth >= 1) && (imHbWindowWidth <= 9999))){
    ...
    var check910571 = document.querySelector("#square") !== null;
    console.log('ID: square / check910571: ' + check910571);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910566 = document.querySelector("#learniv-300x600") !== null;
    console.log('ID: learniv-300x600 / check910566: ' + check910566);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910572 = document.querySelector("#nobranding") !== null;
    console.log('ID: nobranding / check910572: ' + check910572);
...
// unitResponzivita:mobil
  if((imHbWindowWidth <= 1060)){
    ...
    var check910565 = document.querySelector("#patickovy-leaderboard-mobil") !== null;
    console.log('ID: patickovy-leaderboard-mobil / check910565: ' + check910565);
...
// unitResponzivita:desktop
  if((imHbWindowWidth >= 1060)){
    ...
    var check910567 = document.querySelector("#patickovy-leaderboard-desktop") !== null;
    console.log('ID: patickovy-leaderboard-desktop / check910567: ' + check910567);
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1213&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
