 ...
 * Last update: 17.02.2024 12:05:37
 * Ticket ID: ... / [1733]
...
if(bid.bidder == 'adform-sasAll'){
        ...
        console.log('pbjs^^');
        console.log(pbjs); 
        var s = pbjs.getHighestCpmBids(bid.adUnitCode)[0] || void 0;
        console.log('s^^');
        console.log(s);
}
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1733&statistics=0&groupBidsReceivedTable=1&groupRandId=5&hbmasterscript='+hbmasterscript+'&data='+strData);
