 ...
 * Last update: 15.11.2024 22:27:04
 * Ticket ID: ... / [1733]
...
pbjs.que.push(function() {
    ...
    pbjs.aliasBidder('rubicon', 'cpex-tt', {gvlid: 1003, useBaseGvlid: true});
    pbjs.aliasBidder('criteo', 'criteo-im', {gvlid: 1009, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-im-tt', {gvlid: 1013, useBaseGvlid: true});
    pbjs.aliasBidder('rubicon', 'cpex-nt', {gvlid: 1023, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-im-nt', {gvlid: 1038, useBaseGvlid: true});
    pbjs.aliasBidder('appnexus', 'appnexus-cpex', {gvlid: 1042, useBaseGvlid: true});
    pbjs.aliasBidder('pubmatic', 'pubmatic-cpex', {gvlid: 1047, useBaseGvlid: true});
    pbjs.aliasBidder('teads', 'Teads', {gvlid: 1048, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-omd', {gvlid: 1050, useBaseGvlid: true});
    pbjs.aliasBidder('pubmatic', 'pubmatic-im', {gvlid: 1053, useBaseGvlid: true});
    pbjs.aliasBidder('appnexus', 'appnexus-im', {gvlid: 1054, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-fragile', {gvlid: 1055, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-eom-omd', {gvlid: 1056, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-prima', {gvlid: 1058, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-sasAll', {gvlid: 1059, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-sasBranding', {gvlid: 1060, useBaseGvlid: true});
