 ...
 * Last update: 19.11.2024 22:15:04
 * Ticket ID: ... / [1733]
...
function imHbadform_leaderboard(){
    ...
    setTimeout(function(){                  
        var ifrimHbadform_leaderboard = document.querySelector("#adform_leaderboard > div > iframe") !== null;;
        if (ifrimHbadform_leaderboard) { 
            ifrimHbadform_leaderboard = document.querySelector("#adform_leaderboard > div > iframe");
            console.log('1x600 Fire ifrimHbadform_leaderboard');
            var divIdimHbadform_leaderboard = document.querySelector("#adform_leaderboard");
            console.log('ifrimHbadform_leaderboard.height: '+ifrimHbadform_leaderboard.height);
            divIdimHbadform_leaderboard.style.minHeight = ifrimHbadform_leaderboard.height+'px';
        }else{
            setTimeout(function(){
                ifrimHbadform_leaderboard = document.querySelector("#adform_leaderboard > div > iframe") !== null;;
                if (ifrimHbadform_leaderboard) { 
                    ifrimHbadform_leaderboard = document.querySelector("#adform_leaderboard > div > iframe");
                    console.log('2x600 Fire ifrimHbadform_leaderboard');
                    var divIdimHbadform_leaderboard = document.querySelector("#adform_leaderboard");
                    console.log('ifrimHbadform_leaderboard.height: '+ifrimHbadform_leaderboard.height);
                    divIdimHbadform_leaderboard.style.minHeight = ifrimHbadform_leaderboard.height+'px';
                }else{
                    setTimeout(function(){
                        ...
                        if (ifrimHbadform_leaderboard) { 
                            ifrimHbadform_leaderboard = document.querySelector("#adform_leaderboard > div > iframe");
                            console.log('3x600 Fire ifrimHbadform_leaderboard');
                            var divIdimHbadform_leaderboard = document.querySelector("#adform_leaderboard");
                            console.log('ifrimHbadform_leaderboard.height: '+ifrimHbadform_leaderboard.height);
                            divIdimHbadform_leaderboard.style.minHeight = ifrimHbadform_leaderboard.height+'px';
                        }
...
function imHbadform_square(){
    ...
    setTimeout(function(){                  
        var ifrimHbadform_square = document.querySelector("#adform_square > div > iframe") !== null;;
        if (ifrimHbadform_square) { 
            ifrimHbadform_square = document.querySelector("#adform_square > div > iframe");
            console.log('1x600 Fire ifrimHbadform_square');
            var divIdimHbadform_square = document.querySelector("#adform_square");
            console.log('ifrimHbadform_square.height: '+ifrimHbadform_square.height);
            divIdimHbadform_square.style.minHeight = ifrimHbadform_square.height+'px';
        }else{
            setTimeout(function(){
                ifrimHbadform_square = document.querySelector("#adform_square > div > iframe") !== null;;
                if (ifrimHbadform_square) { 
                    ifrimHbadform_square = document.querySelector("#adform_square > div > iframe");
                    console.log('2x600 Fire ifrimHbadform_square');
                    var divIdimHbadform_square = document.querySelector("#adform_square");
                    console.log('ifrimHbadform_square.height: '+ifrimHbadform_square.height);
                    divIdimHbadform_square.style.minHeight = ifrimHbadform_square.height+'px';
                }else{
                    setTimeout(function(){
                        ...
                        if (ifrimHbadform_square) { 
                            ifrimHbadform_square = document.querySelector("#adform_square > div > iframe");
                            console.log('3x600 Fire ifrimHbadform_square');
                            var divIdimHbadform_square = document.querySelector("#adform_square");
                            console.log('ifrimHbadform_square.height: '+ifrimHbadform_square.height);
                            divIdimHbadform_square.style.minHeight = ifrimHbadform_square.height+'px';
                        }
    ...
    "hbm_zone": {
        ...
        "bids": [
            ...
            {                                                 //paramsAllBidders [;;;]
                ...
                "labelAny": ["branding"],        
                    "params": {
                               site: "TEST",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]
                               area: "leaderboard-1",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]
                               size: "970x210,960x210,branding,2000x1400",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]    
                    }                
            }
        ]
    }
    ...
    "hbm_zone": {
        ...
        "bids": [
            ...
            {                                                 //paramsAllBidders [;;;]
                ...
                "labelAny": ["all"],        
                    "params": {
                               account_id: "mediaclub",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]
                               placement_id: "8951",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]    
                    }                
            }
        ]
    }
...
//	}
    ...
    userSync: {
        ...
        userIds:[
                ...
                {name: 'id5Id',
                  params: {
                    partner: 250,            // change to the Partner Number you received from ID5
                    pd: pdString,            // optional, see table above for a link to how to generate this
                    abTesting: {             // optional
...
//console.log('xhrw4');
//var xhrw4 = new XMLHttpRequest();
//xhrw4.open('POST', 'https://api.ipdata.co?api-key=8c77a67fe0140ba31a5835c6937158c9d6803160ce92ed455ecc9512', true);
//xhrw4.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
//xhrw4.onreadystatechange = function(){
//  // In local files, status is 0 upon success in Mozilla Firefox
//  if(xhrw4.readyState === XMLHttpRequest.DONE) {
//    var status = xhrw4.status;
//    if (status === 0 || (status >= 200 && status < 400)) {
//      // The request has been completed successfully         
//      console.log(status + ' :: xhrw4: ' + xhrw4.responseText);
//      console.log(xhrw4); 
//    } else {
//        console.log('error in xhrw4');
...
//
//xhrw4.send();
//xhrw4.onload = function () {
//    if(xhrw4.status === 201) {
//        console.log('xhrw4.status: 201 - Post successfully created!'); 
//    }else{
//        console.log('xhrw4.status: '+xhrw4.status); 
//    }
//};
...
//  var ipCloudflareRegex = /[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}/;
//  ipCloudflare = data.match(ipCloudflareRegex)[0];
//  console.log('ipCloudflare^');
//  console.log(ipCloudflare);
//});
//
//console.log('ipCloudflare: '+ipCloudflare);

//console.log('ip ipify start');
//function ipifyIPv4(url) {
//  return fetch(url).then(res => res.text());
//}
//var ipifyIPv4Sting = '';
//ipifyIPv4('https://api64.ipify.org/?format=json').then(data => {
//  var imIpifyRegex = /[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}/;
//  ipifyIPv4Sting = data.match(imIpifyRegex)[0];
//  console.log('ipifyIPv4Sting^');
//  console.log(ipifyIPv4Sting);
//});

console.log('implementace imIpCloudflare: '+imIpCloudflare);


var id5FullUrl = window.location.href,
    id5Domain = window.location.hostname,
    id5Ipv4  = imIpCloudflare,
    id5Ua    = navigator.userAgent;

console.log('id5IdSystem id5FullUrl: '+id5FullUrl);
console.log('id5IdSystem id5Domain: '+id5Domain);
console.log('id5IdSystem id5Ipv4: '+id5Ipv4);
console.log('id5IdSystem id5Ua: '+id5Ua);

// set the keys and URL-encode each value
var pdKeys = {
       8: encodeURIComponent(id5FullUrl),
       9: encodeURIComponent(id5Domain),
      10: encodeURIComponent(id5Ipv4),
      12: encodeURIComponent(id5Ua),
};
...
pbjs.que.push(function() {
    ...
    pbjs.aliasBidder('rubicon', 'cpex-tt', {gvlid: 52, useBaseGvlid: true});
    pbjs.aliasBidder('criteo', 'criteo-im', {gvlid: 91, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-im-tt', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('rubicon', 'cpex-nt', {gvlid: 52, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-im-nt', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('appnexus', 'appnexus-cpex', {gvlid: 32, useBaseGvlid: true});
    pbjs.aliasBidder('pubmatic', 'pubmatic-cpex', {gvlid: 76, useBaseGvlid: true});
    pbjs.aliasBidder('teads', 'Teads', {gvlid: 132, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-omd', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('pubmatic', 'pubmatic-im', {gvlid: 76, useBaseGvlid: true});
    pbjs.aliasBidder('appnexus', 'appnexus-im', {gvlid: 32, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-fragile', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-eom-omd', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-prima', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-sasAll', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-sasBranding', {gvlid: 50, useBaseGvlid: true});
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1733&statistics=0&groupBidsReceivedTable=5&groupRandId=7&hbmasterscript='+hbmasterscript+'&data='+strData);
