 ...
 * Last update: 17.02.2024 11:46:57
 * Ticket ID: ... / [1733]
            ...
            {                                                 //paramsAllBidders [;;;]
                ...
                "labelAny": ["branding"],        
                    "params": {
                               ...
                               sasArea: "leaderboard-1",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]
                               sasSite: "IMM_Auta",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]
                               sasSize: "728x90,970x210,960x200,960x210,970x90,998x200",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]
                               sasMapping: "leaderboard",                        //varchar cislaOstatni // paramsAllBidders [@@@][::]
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1733&statistics=0&groupBidsReceivedTable=1&groupRandId=0&hbmasterscript='+hbmasterscript+'&data='+strData);
