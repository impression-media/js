 ...
 * Last update: 17.11.2024 0:20:44
 * Ticket ID: ... / [1733]
...
pbjs.que.push(function() {
    ...
    pbjs.aliasBidder('rubicon', 'cpex-tt', {gvlid: 3, useBaseGvlid: true});
    pbjs.aliasBidder('criteo', 'criteo-im', {gvlid: 9, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-im-tt', {gvlid: 13, useBaseGvlid: true});
    pbjs.aliasBidder('rubicon', 'cpex-nt', {gvlid: 23, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-im-nt', {gvlid: 38, useBaseGvlid: true});
    pbjs.aliasBidder('appnexus', 'appnexus-cpex', {gvlid: 42, useBaseGvlid: true});
    pbjs.aliasBidder('pubmatic', 'pubmatic-cpex', {gvlid: 47, useBaseGvlid: true});
    pbjs.aliasBidder('teads', 'Teads', {gvlid: 48, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-omd', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('pubmatic', 'pubmatic-im', {gvlid: 53, useBaseGvlid: true});
    pbjs.aliasBidder('appnexus', 'appnexus-im', {gvlid: 54, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-fragile', {gvlid: 55, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-eom-omd', {gvlid: 56, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-prima', {gvlid: 58, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-sasAll', {gvlid: 59, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-sasBranding', {gvlid: 60, useBaseGvlid: true});
