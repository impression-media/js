 ...
 * Last update: 14.11.2024 9:51:52
 * Ticket ID: ... / [1733]
...
pbjs.que.push(function() {
    ...
    pbjs.aliasBidder('rubicon', 'cpex-tt', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('criteo', 'criteo-im', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-im-tt', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('rubicon', 'cpex-nt', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-im-nt', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('appnexus', 'appnexus-cpex', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('pubmatic', 'pubmatic-cpex', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('teads', 'Teads', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('adform', 'adform-omd', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('pubmatic', 'pubmatic-im', {gvlid: 50, useBaseGvlid: true});
    pbjs.aliasBidder('appnexus', 'appnexus-im', {gvlid: 50, useBaseGvlid: true});
