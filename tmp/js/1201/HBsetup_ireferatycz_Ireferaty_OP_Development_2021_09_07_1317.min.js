...
//adformtag.resetTargeting(s), // remove old data, required only if same mids a used
        ...
        n(t);
        console.log('lg-006a IMPRESSION_ppas_setPPASTargetingForAdUnit pbjs.que^^');
        console.log(pbjs.que);
        console.log('lg-006b IMPRESSION_ppas_setPPASTargetingForAdUnit t^^');
        console.log(t);
    }
