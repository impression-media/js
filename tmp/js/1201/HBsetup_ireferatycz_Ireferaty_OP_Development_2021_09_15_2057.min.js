...
var checkReloadingAdsRestriction; 
    console.log('podClanek-desktop : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 2' + '' );
    checkReloadingAdsRestriction = 1 - (2 - imHbReloadingAds);
...
console.log('no URL condition');
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 2' + '' );
    checkReloadingAdsRestriction = 1 - (2 - imHbReloadingAds);
