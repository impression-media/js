...
//    }
    ...
    if(datahbmasterscriptDigit == 0){document.querySelector('#'+t.hb_adUnitCode).innerHTML = '<sc'+'ript src="//s1.adform.net/banners/scripts/adx.js" data-adfscript="adx.adform.net/adx/?mid='+s+'"></scr'+'ipt>'}
