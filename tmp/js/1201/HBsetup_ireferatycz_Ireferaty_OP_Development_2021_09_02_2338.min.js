    ...
    if(imCappingStopDS == "NE"){
        ...
        if (selection) {
         ...
         if (selection) {
            ...
            //imStripContent = "<div id=\""+weuron.log.dividStrip+"\"><script data-adfscript=\"adx.adform.net/adx/?mid="+weuron.log.midDS+"\"></script></div>";
...
var checkReloadingAdsRestriction; 
    console.log('top-leaderboard-vse : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 1000 - (1 - imHbReloadingAds);
    ...
    console.log('square-ir : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 1000 - (1 - imHbReloadingAds);
    ...
    console.log('bottom-leaderboard-desktop : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 1000 - (1 - imHbReloadingAds);
    ...
    console.log('bottom-leaderboard-mobil : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 1000 - (1 - imHbReloadingAds);
    ...
    console.log('podClanek-desktop : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 1000 - (1 - imHbReloadingAds);
    ...
    console.log('podClanek-mobil : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 1000 - (1 - imHbReloadingAds);
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 1000 - (1 - imHbReloadingAds);
    ...
    console.log('adformDesktopStrip : DEV TEST >> unitReloadingAdsRestriction: 1000 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 1' + '' );
    checkReloadingAdsRestriction = 1000 - (1 - imHbReloadingAds);
...
pbjs.onEvent('auctionEnd', function(data){
    ...
    if(dataAdUnitCodesString.indexOf('caroda') > -1){
        ...
        setTimeout(function(){
            ...
            console.log('pbjs.winningBids^^');
            console.log(pbjs.winningBids);
            Object.keys(pbjs.winningBids).forEach(function(key) {
              console.log(key, pbjs.winningBids[key]);
              if(imHbWonBids.includes(pbjs.winningBids[key].requestId)){
                  //OK
              }else{
...
//}, 500);
        ...
        setTimeout(function(){
            ...
            console.log('auctionEnd hbmasterscript: '+hbmasterscript); 
        }, (40000 - 5000));
...
var pbjsBidWon = pbjs.onEvent('bidWon', function(data){       
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            document.querySelector("#top-leaderboard-vse").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=453517"></scr'+'ipt>';            
           }
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            document.querySelector("#bottom-leaderboard-desktop").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=453518"></scr'+'ipt>';            
           }
  ...
  if(((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199)) || (pbjs.WEURON_WindowWidth <= 767)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            document.querySelector("#bottom-leaderboard-mobil").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=614449"></scr'+'ipt>';            
           }
  ...
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            document.querySelector("#podClanek-desktop").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=453520"></scr'+'ipt>';            
           }
  ...
  if(((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199)) || (pbjs.WEURON_WindowWidth <= 767)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            document.querySelector("#podClanek-mobil").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=614450"></scr'+'ipt>';            
           }
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            document.querySelector("#adformMobilniBranding").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=1104770"></scr'+'ipt>';            
           }
...
//          "refresh_limit": 0,        
        ...
        console.log('Responzivita = FALSE >> Placement / MID: adformMobilniBranding / 1104770  (' + pbjs.WEURON_WindowWidth + ')');
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            ...
            document.querySelector("#adformDesktopStrip").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=938107"></scr'+'ipt>';            
           }
...
//    }
    ...
    }, pbjs.IMPRESSION_ppas_setPPASTargetingForAdUnit = function(e, t, s) {
        var m;
        m = void 0 !== pbjs.WEURON_MapPositions  && pbjs.WEURON_MapPositions [e] ? pbjs.WEURON_MapPositions [e] : (m = e.split("-"))[m.length - 1];
        ...
        if(imHbPlacementEnable.includes(e)){
            ...
            console.log('lg-004b IMPRESSION_ppas_setPPASTargetingForAdUnit m: ', m);
            var n = function(t) {
    ...
    adformtag.resetTargeting(m), // remove old data, required only if same mids a used
                    adformtag.setTargeting(m, "hbkey", "hb-nobids-" + e),
                    adformtag.setTargeting(m, "hbtier", "hb-" + e + "-" + "noBids"),
                    adformtag.setTargeting(m, "hbtier_hb_pb", 1)
                } else { 
    adformtag.push ({preload: ['adx.adform.net/adx/?mid='+m]}),
    adformtag.resetTargeting(m), // remove old data, required only if same mids a used
                    adformtag.setTargeting(m, "hb_bidder", t.hb_bidder),                
                    adformtag.setCustomData(m, "hb_adid", t.hb_adId), 
                    pbjs.WEURON_log("lg-005a: adformtag.setTargeting(" + m + ', "hb_bidder", ' + t.hb_bidder + ")"),                
                    pbjs.WEURON_log("lg-005b: adformtag.setCustomData(" + m + ', "hb_adid", ' + t.hb_adId + ")"),
                    pbjs.IMPRESSION_useKeywords && 
                             (
                             pbjs.WEURON_log("lg-005c: adformtag.setTargeting(" + m + ', "hbkey", hb-' + e + ")"),
                             //pbjs.WEURON_log("lg-005d: adformtag.setTargeting(" + m + ', "hbtier", hb-' + e + "-" + t.hb_pb + ")"),
                             pbjs.WEURON_log("lg-005d: adformtag.setTargeting(" + m + ', "hbtier", hb-' + tierAlias[m] + "-" + t.hb_pb + ")"),
                             pbjs.WEURON_log("lg-005d-new: adformtag.setTargeting(" + m + ', "hbtier_hb_pb", ' + t.hb_pb + ")"),                         
                             //pbjs.WEURON_log("lg-005e: adformtag.setTargeting(" + m + ', "hbssp", ' + bidderAlias[t.hb_bidder] + ")"),
                             pbjs.WEURON_log("lg-005e: adformtag.setTargeting(" + m + ', "hbalias", ' + t.hb_bidderAlias + ")"), 
                             adformtag.setTargeting(m, "hbkey", "hb-" + e),
                             //adformtag.setTargeting(m, "hbtier", "hb-" + e + "-" + t.hb_pb),
                             adformtag.setTargeting(m, "hbtier", "hb-" + tierAlias[m] + "-" + t.hb_pb),
                             adformtag.setTargeting(m, "hbtier_hb_pb", t.hb_pb),
                             //adformtag.setTargeting(m, "hbssp", bidderAlias[t.hb_bidder])
                             adformtag.setTargeting(m, "hbalias", t.hb_bidderAlias) 
                             ),

                    pbjs.WEURON_log("lg-005e: adformtag.setPrice(" + m + ", " + t.hb_price + ")"),
                    adformtag.setPrice(m, t.hb_price),
                    adformtag.onLoaded(m, function (adItemOnLoaded){
                    ...
                    adformtag.onRendered(m, function (adItemOnRendered){
