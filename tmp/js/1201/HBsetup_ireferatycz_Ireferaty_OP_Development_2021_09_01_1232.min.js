...
pbjs.WEURON_PlacementEnable  = {};
var imHbPlacementEnable = [];
...
console.log('no URL condition');
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['top-leaderboard-vse'] = '453517';
...
console.log('no URL condition');
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['square-ir'] = '453521';
...
console.log('no URL condition');
  if(((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199)) || (pbjs.WEURON_WindowWidth <= 767)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['top-leaderboard-vse'] = '614447';
            imHbPlacementEnable.push('top-leaderboard-vse');
...
console.log('no URL condition');
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['bottom-leaderboard-desktop'] = '453518';
...
console.log('no URL condition');
  if(((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199)) || (pbjs.WEURON_WindowWidth <= 767)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['bottom-leaderboard-mobil'] = '614449';
...
console.log('no URL condition');
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['podClanek-desktop'] = '453520';
...
console.log('no URL condition');
  if(((pbjs.WEURON_WindowWidth >= 768) && (pbjs.WEURON_WindowWidth <= 1199)) || (pbjs.WEURON_WindowWidth <= 767)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['podClanek-mobil'] = '614450';
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if(((pbjs.WEURON_WindowWidth >= 1) && (pbjs.WEURON_WindowWidth <= 10000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['adformMobilniBranding'] = '1104770';
...
console.log('no Web Variable');//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            pbjs.WEURON_PlacementEnable ['adformDesktopStrip'] = '938107';
