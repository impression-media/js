...
var checkReloadingAdsRestriction; 
    console.log('podClanek-desktop : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
...
console.log('no URL condition');
  if((pbjs.WEURON_WindowWidth >= 1200)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 3' + '' );
    checkReloadingAdsRestriction = 1 - (3 - imHbReloadingAds);
