...
pbjs.onEvent('auctionEnd', function(data){
    ...
    if(dataAdUnitCodesString.indexOf('caroda') > -1){
        ...
        setTimeout(function(){
            ...
            console.log(pbjs.winningBids);
            console.log('pbjs.winningBids.length: '+pbjs.winningBids.length);            
            for (var w = 0; w < pbjs.winningBids.length; w++){
                statisticsAuctionEnd(pbjs.winningBids.requestId+'|'+pbjs.winningBids.auctionId, 'bidsWon');
            }
