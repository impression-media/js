...
//    }
    ...
    adformtag.resetTargeting(m), // remove old data, required only if same mids a used
                    ...
                    adformtag.onLoaded(m, function (t,s){
                      console.log('adItemOnLoaded^^');
                      console.log('hb_auctionId: '+t.hb_auctionId);
                      console.log('hb_requestId: '+t.hb_requestId);
                      console.log('hb_adId: '+t.hb_adId);                      
                      console.log(s);
                    }),
                    adformtag.onRendered(m, function (t){
