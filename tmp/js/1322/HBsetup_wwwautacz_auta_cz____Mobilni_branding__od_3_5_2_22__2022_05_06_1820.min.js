                ...
                setTimeout(function(){
                    ...
                    if (selection) {
                        ...
                        if((ssspIframeHeight*3)>screen.height){
                            vat scaleFloor = Math.floor(((screen.height / (ssspIframeHeight*3))*10)/10;
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('AdTrackGenericInterscrollerDesktop : DEV TEST >> unitReloadingAdsRestriction: 0 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: -1' + '' );
    checkReloadingAdsRestriction = 1; 
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            ...
            document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 0');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#AdTrackGenericInterscrollerDesktop").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 0');
            }
        }
    }else{ 
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 15 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: -1' + '' );
    checkReloadingAdsRestriction = 1; 
    ...
    console.log('adform_squarem : DEV TEST >> unitReloadingAdsRestriction: 0 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: -1' + '' );
    checkReloadingAdsRestriction = 1; 
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            ...
            document.querySelector("#adform_squarem").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 0');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_squarem").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 0');
            }
        }
    }else{ 
    ...
    console.log('adform_square : DEV TEST >> unitReloadingAdsRestriction: 0 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: -1' + '' );
    checkReloadingAdsRestriction = 1; 
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            ...
            document.querySelector("#adform_square").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 0');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_square").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 0');
            }
        }
    }else{ 
    ...
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 0 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: -1' + '' );
    checkReloadingAdsRestriction = 1; 
        ...
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            ...
            document.querySelector("#adform_leaderboard").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 0');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_leaderboard").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 0');
            }
        }
    }else{ 
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 0 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: -1' + '' );
    checkReloadingAdsRestriction = 1; 
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    console.log('PROD >> unitReloadingAdsRestriction: 15 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: -1' + '' );
    checkReloadingAdsRestriction = 1; 
