 ...
 * Last update: 10.05.2022  13:37
 * Generated for WebSite: [https://www.auta.cz] 
 * Custom ticket name: [auta.cz  + Mobilni branding (od 3.5.2022)]     
 * AdServer:  [adform]       
 * Ticket ID: ... / [1322]
 * User ID: [1]    
...
pbjs.WEURON_HbMin = 5;
var hbConfigOnloadTimeout = 2000;
var bidderFloor = { 
    "criteo-im": 3,
    "adform-im-tt": 3,
    "adform-im-nt": 3,
...
var webBidders = 'adform-im-tt,adform-omd,criteo-im,adform-im-nt,appnexus,PubMatic,Teads';    
var placementFloor = { 
...
var tierAlias = { 
    "1026831": "adform_interscroller",
    "1026840": "adform_mobilnibranding",
    "1026836": "adform_squarem",
    "1026828": "adform_square",
    "1026804": "adform_leaderboard",
};
var responzivita = { 
    "AdTrackGenericInterscrollerDesktop": "mobil",
    "adformMobilniBranding": "mobil",
    "adform_squarem": "mobil",
...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    console.log('AdTrackGenericInterscrollerDesktop : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        console.log('ID: AdTrackGenericInterscrollerDesktop / MID:1026831 / DIV ID found: ' + nonResponsiveLeaveBlank);
    ...
    console.log('adformMobilniBranding : DEV TEST >> unitReloadingAdsRestriction: 15 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        ...
        console.log('ID: adformMobilniBranding / MID:1026840 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
    ...
    console.log('adform_squarem : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        checkReloadingAdsRestriction = 1 - (15 - imHbReloadingAds);
        
        console.log('imHbReloadingAds:: '+imHbReloadingAds);
        console.log('imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction); 
        if (checkReloadingAdsRestriction < 0) {
            console.log('adform_squarem : REMOVE imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction); 
        }
        responsiveConditionReady = document.querySelector("#adform_squarem") !== null;
        console.log('ID: adform_squarem / MID:1026836 / DIV ID found: ' + responsiveConditionReady);
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            document.querySelector("#adform_squarem").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript id=\'im-script-adform_squarem\' src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=1026836"></scr'+'ipt>'; 
            document.querySelector("#adform_squarem").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 1');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_squarem").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 1');
            }
        }
    }else{ 
        nonResponsiveLeaveBlank = document.querySelector("#adform_squarem") !== null;
        console.log('ID: adform_squarem / MID:1026836 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#adform_squarem").innerHTML += '<span style="display:none !important">Responsive condition is FALSE >> Empty placement DIV ID</span>';
            remImScript = document.querySelector('#im-script-adform_squarem') !== null;
            if (remImScript) {
                document.querySelector('#im-script-adform_squarem').remove();
            }
       }
    }
    if((pbjs.WEURON_WindowWidth >= 1000)){

    console.log('adform_square : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        checkReloadingAdsRestriction = 1 - (15 - imHbReloadingAds);
        ...
        console.log('ID: adform_square / MID:1026828 / DIV ID found: ' + responsiveConditionReady);
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            document.querySelector("#adform_square").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript id=\'im-script-adform_square\' src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=1026828"></scr'+'ipt>'; 
            document.querySelector("#adform_square").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 1');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_square").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 1');
            }
        }
    }else{ 
        nonResponsiveLeaveBlank = document.querySelector("#adform_square") !== null;
        console.log('ID: adform_square / MID:1026828 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
    ...
    console.log('adform_leaderboard : DEV TEST >> unitReloadingAdsRestriction: 1 vs imHbReloadingAds: ' + imHbReloadingAds + ' from reloadingAds: 15' + '' );
        checkReloadingAdsRestriction = 1 - (15 - imHbReloadingAds);
        ...
        console.log('ID: adform_leaderboard / MID:1026804 / DIV ID found: ' + responsiveConditionReady);
        if ((responsiveConditionReady)&&(checkReloadingAdsRestriction > 0)) {    
            document.querySelector("#adform_leaderboard").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript id=\'im-script-adform_leaderboard\' src=\'//s1.adform.net/banners/scripts/adx.js\' data-adfscript="adx.adform.net/adx/?mid=1026804"></scr'+'ipt>'; 
            document.querySelector("#adform_leaderboard").setAttribute('data-checkReloadingAdsRestriction', 'Ready as '+checkReloadingAdsRestriction+' from 1');

        }else{
            if (responsiveConditionReady){
                document.querySelector("#adform_leaderboard").setAttribute('data-checkReloadingAdsRestriction', 'Stop as '+checkReloadingAdsRestriction+' from 1');
            }
        }
    }else{ 
        nonResponsiveLeaveBlank = document.querySelector("#adform_leaderboard") !== null;
        console.log('ID: adform_leaderboard / MID:1026804 / DIV ID found: ' + nonResponsiveLeaveBlank);
        if (nonResponsiveLeaveBlank) {
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1322&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: AdTrackGenericInterscrollerDesktop / hbPlacement1026831: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['AdTrackGenericInterscrollerDesktop'] = '1026831';
        }else{
            console.log('hbPlacement for unitCustomID AdTrackGenericInterscrollerDesktop is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: AdTrackGenericInterscrollerDesktop / 1026831  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwautacz-1-1322-911402',
...
//          "refresh_limit": 0,        
        ...
        } pbjs.WEURON_MapPositions['AdTrackGenericInterscrollerDesktop'] = '1026831';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: AdTrackGenericInterscrollerDesktop / 1026831  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1026831 = document.querySelector("#AdTrackGenericInterscrollerDesktop") !== null;
//      console.log('ID: AdTrackGenericInterscrollerDesktop / check1026831: ' + check1026831);
//      if (check1026831) {
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        console.log('ID: adformMobilniBranding / hbPlacement1026840: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['adformMobilniBranding'] = '1026840';
        }else{
            console.log('hbPlacement for unitCustomID adformMobilniBranding is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adformMobilniBranding / 1026840  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwautacz-1-1322-911403',
            code: 'adformMobilniBranding',
                mediaTypes: {
                   banner: {sizes: [
               [320,50],[320,150],[300,100],[300,50],[300,300],[300,250],[336,280],[250,250],[300,150],[480,300],[970,350],[970,250],[970,210],[970,90],[970,310],[728,90],[300,120]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
            
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "auta/Mobilnibranding_1026840",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions['adformMobilniBranding'] = '1026840';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adformMobilniBranding / 1026840  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1026840 = document.querySelector("#adformMobilniBranding") !== null;
//      console.log('ID: adformMobilniBranding / check1026840: ' + check1026840);
//      if (check1026840) {
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    console.log('PROD >> imHbReloadingAds >> checkReloadingAdsRestriction: '+checkReloadingAdsRestriction);
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#adform_squarem") !== null;
        if('adformMobilniBranding' == ''){hbPlacement = true;} 
        console.log('ID: adform_squarem / hbPlacement1026836: ' + hbPlacement);
        if (hbPlacement) {
            console.log('hbPlacement for unitCustomID adform_squarem is enable');
            if(!imHbPlacementEnable.includes('adform_squarem')){
                imHbPlacementEnable.push('adform_squarem');
            }
            imHbAsocPlacementMidEnable['adform_squarem'] = '1026836';
        }else{
            console.log('hbPlacement for unitCustomID adform_squarem is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adform_squarem / 1026836  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwautacz-1-1322-911401',
            code: 'adform_squarem',
                mediaTypes: {
                   banner: {sizes: [
               [300,300],[300,250],[160,600],[120,600],[240,400],[300,600]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
            
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "auta/Square_mobile_1026836",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions['adform_squarem'] = '1026836';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adform_squarem / 1026836  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1026836 = document.querySelector("#adform_squarem") !== null;
//      console.log('ID: adform_squarem / check1026836: ' + check1026836);
//      if (check1026836) {
//          document.querySelector("#adform_squarem").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if('adformMobilniBranding' == ''){hbPlacement = true;} 
        console.log('ID: adform_square / hbPlacement1026828: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['adform_square'] = '1026828';
        }else{
            console.log('hbPlacement for unitCustomID adform_square is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adform_square / 1026828  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwautacz-1-1322-911400',
            code: 'adform_square',
                mediaTypes: {
                   banner: {sizes: [
               [300,300],[300,250],[160,600],[120,600],[240,400],[300,600]
...
//          "refresh_limit": 0,        
            ...
            "bids": [
            
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "auta/Square_1026828",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions['adform_square'] = '1026828';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adform_square / 1026828  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1026828 = document.querySelector("#adform_square") !== null;
//      console.log('ID: adform_square / check1026828: ' + check1026828);
//      if (check1026828) {
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if('adformMobilniBranding' == ''){hbPlacement = true;} 
        console.log('ID: adform_leaderboard / hbPlacement1026804: ' + hbPlacement);
        if (hbPlacement) {
            ...
            imHbAsocPlacementMidEnable['adform_leaderboard'] = '1026804';
        }else{
            console.log('hbPlacement for unitCustomID adform_leaderboard is not enable');
        }

        console.log('Responzivita = TRUE >> Placement / MID: adform_leaderboard / 1026804  (' + pbjs.WEURON_WindowWidth + ')');    
        pbjs.adUnits.push(    
        {
            id: 'wwwautacz-1-1322-911398',
            code: 'adform_leaderboard',
                mediaTypes: {
                   banner: {sizes: [
               [1000,200],[980,200],[745,100],[728,90],[750,200],[750,100],[990,100],[990,110],[990,200],[980,100],[980,120],[920,200],[900,200],[970,250],[970,210],[970,90],[970,200],[2000,1400],[1000,250]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
            
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "auta/Leaderboard_1026804",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions['adform_leaderboard'] = '1026804';
  
      }else{
        console.log('Remove / Responzivita = FALSE >> Placement / MID: adform_leaderboard / 1026804  (' + pbjs.WEURON_WindowWidth + ')');
//      var check1026804 = document.querySelector("#adform_leaderboard") !== null;
//      console.log('ID: adform_leaderboard / check1026804: ' + check1026804);
//      if (check1026804) {
