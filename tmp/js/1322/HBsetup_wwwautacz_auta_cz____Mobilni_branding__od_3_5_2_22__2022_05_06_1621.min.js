...
var webBidders = 'adform-im-tt,criteo-im,adform-im-nt,appnexus,PubMatic,adform-omd,Teads';    
var placementFloor = { 
    ...
    function imRozcetnikWraperADF100p(weuronLogTimeout){
        ...
        if(tmpStr !== null){
            ...
            if(tmpStr !== null){
                ...
                setTimeout(function(){
                    var selectnion = document.getElementById("adformMobilniBranding") !== null;
                    if (selection) {
                        console.log("!!! 1000 selection adformMobilniBranding");
                        document.querySelector("#adformMobilniBranding>iframe").style.minHeight  = "100px";
                        setTimeout(function(){
                            console.log("contentWindow .sssp-resizeCont iframe");
                            ...
                            if (selection) {
                                ...
                                console.log("dynamic height: "+ document.querySelector("#adformMobilniBranding>iframe").style.minHeight);
                                document.querySelector("#adfContainerMobil").style.height = ssspIframeHeight+"px";
                            }else{
                                console.log("1. NOT selection contentWindow .sssp-resizeCont iframe");
                            }
                        },100);
                    }else{
