    ...
    function imRozcetnikWraperADF100p(weuronLogTimeout){
        ...
        if(tmpStr !== null){
            ...
            if(tmpStr !== null){
                ...
                var ifrFixSizeSetting = "<span style=\"width:320px; height:200px; display:none\" class=\"imFeedSizeSetting\"><span>";
                tmpStr  = ifrFixSizeSetting.match(/(.)*/ig); 
                if(weuron.log.dev !== "notSet"){
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    checkReloadingAdsRestriction = 1; 
        ...
        var delId911403Mid1026840 = document.querySelector("#cssId911403Mid1026840") !== null;
        if (delId911403Mid1026840) {
            document.querySelector('#cssId911403Mid1026840').remove();
        }
    
    var cssId911403Mid1026840 = document.createElement('style');
    cssId911403Mid1026840.type = 'text/css';
    cssId911403Mid1026840.id = 'cssId911403Mid1026840';
    if(!!(window.attachEvent && !window.opera)) {
        cssId911403Mid1026840.styleSheet.cssText = '#adformMobilniBranding>iframe{height:100px !important;}';
    } else {
        var styleText911403Mid1026840 = document.createTextNode('#adformMobilniBranding>iframe{height:100px !important;}');
        cssId911403Mid1026840.appendChild(styleText911403Mid1026840);
    }
    document.getElementsByTagName('head')[0].appendChild(cssId911403Mid1026840);
