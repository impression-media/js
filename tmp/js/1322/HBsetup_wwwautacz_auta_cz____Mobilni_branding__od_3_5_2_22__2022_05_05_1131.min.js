...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(!!(window.attachEvent && !window.opera)) {
        cssId911403Mid1026840.styleSheet.cssText = '#adformMobilniBranding>iframe{min-height:100px}';
    } else {
        var styleText911403Mid1026840 = document.createTextNode('#adformMobilniBranding>iframe{min-height:100px}');
