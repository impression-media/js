                    ...
                    if (selection) {
                        ...
                        setTimeout(function(){
                            ...
                            if (selection) {
                                ...
                                document.querySelector("#adformMobilniBranding>iframe").style.height = ssspIframeHeight+"px";
                                console.log("dynamic height: "+ document.querySelector("#adformMobilniBranding>iframe").style.height);
                            }else{
