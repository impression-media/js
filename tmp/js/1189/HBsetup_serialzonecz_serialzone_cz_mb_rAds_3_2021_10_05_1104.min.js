...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    if(((pbjs.WEURON_WindowWidth >= 800) && (pbjs.WEURON_WindowWidth <= 1359))){
        ...
        setTimeout(function(){
//            var imMinHeighttop-leaderboard-desktop = document.querySelector("#top-leaderboard-desktop iframe").height();
//            document.querySelector("#top-leaderboard-desktop").setAttribute('im-min-height', imMinHeighttop-leaderboard-desktop);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 799)){
        ...
        setTimeout(function(){
//            var imMinHeighttop-leaderboard-mobil = document.querySelector("#top-leaderboard-mobil iframe").height();
//            document.querySelector("#top-leaderboard-mobil").setAttribute('im-min-height', imMinHeighttop-leaderboard-mobil);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth >= 800)){
        ...
        setTimeout(function(){
//            var imMinHeightbottom-leaderboard-desktop = document.querySelector("#bottom-leaderboard-desktop iframe").height();
//            document.querySelector("#bottom-leaderboard-desktop").setAttribute('im-min-height', imMinHeightbottom-leaderboard-desktop);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 799)){
        ...
        setTimeout(function(){
//            var imMinHeightbottom-leaderboard-mobil = document.querySelector("#bottom-leaderboard-mobil iframe").height();
//            document.querySelector("#bottom-leaderboard-mobil").setAttribute('im-min-height', imMinHeightbottom-leaderboard-mobil);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if(((pbjs.WEURON_WindowWidth >= 0) && (pbjs.WEURON_WindowWidth <= 3000))){
        ...
        setTimeout(function(){
//            var imMinHeightsquare1 = document.querySelector("#square1 iframe").height();
//            document.querySelector("#square1").setAttribute('im-min-height', imMinHeightsquare1);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if(((pbjs.WEURON_WindowWidth >= 0) && (pbjs.WEURON_WindowWidth <= 3000))){
        ...
        setTimeout(function(){
//            var imMinHeightsquare2 = document.querySelector("#square2 iframe").height();
//            document.querySelector("#square2").setAttribute('im-min-height', imMinHeightsquare2);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth >= 1360)){
        ...
        setTimeout(function(){
//            var imMinHeighttop-leaderboard-branding = document.querySelector("#top-leaderboard-branding iframe").height();
//            document.querySelector("#top-leaderboard-branding").setAttribute('im-min-height', imMinHeighttop-leaderboard-branding);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth >= 800)){
        ...
        setTimeout(function(){
//            var imMinHeightscyscraper-levy = document.querySelector("#scyscraper-levy iframe").height();
//            document.querySelector("#scyscraper-levy").setAttribute('im-min-height', imMinHeightscyscraper-levy);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 799)){
        ...
        setTimeout(function(){
//            var imMinHeightInterscroller = document.querySelector("#Interscroller iframe").height();
//            document.querySelector("#Interscroller").setAttribute('im-min-height', imMinHeightInterscroller);          
        }, (50000 - 5000));
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 799)){
        ...
        setTimeout(function(){
//            var imMinHeightadformMobilniBranding = document.querySelector("#adformMobilniBranding iframe").height();
//            document.querySelector("#adformMobilniBranding").setAttribute('im-min-height', imMinHeightadformMobilniBranding);          
        }, (50000 - 5000));
        }
    }else{ 
