...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    if((pbjs.WEURON_WindowWidth >= 1360)){
        checkReloadingAdsRestriction = 0 - (15 - imHbReloadingAds); 
        if (checkReloadingAdsRestriction < 0) { 
        }
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1189&statistics=1&hbmasterscript='+hbmasterscript+'&data='+strData);
