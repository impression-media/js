...
var checkReloadingAdsRestriction;
    ...
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#top-leaderboard-desktop").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 3 - (20 - imHbReloadingAds); 
    if (checkReloadingAdsRestriction > 0) {     
    ...
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#square1").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 3 - (20 - imHbReloadingAds); 
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#square2").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 3 - (20 - imHbReloadingAds); 
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#top-leaderboard-branding").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 3 - (20 - imHbReloadingAds); 
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#scyscraper-levy").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    ...
    if (checkReloadingAdsRestriction > 0) {     
        ...
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#Interscroller").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if(((pbjs.WEURON_WindowWidth >= 800) && (pbjs.WEURON_WindowWidth <= 1359))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#top-leaderboard-desktop").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=748059"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for URL condition
  if((pbjs.WEURON_WindowWidth <= 799)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#top-leaderboard-mobil").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=752130"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 800)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#bottom-leaderboard-desktop").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=748069"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 799)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#bottom-leaderboard-mobil").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=752121"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if(((pbjs.WEURON_WindowWidth >= 0) && (pbjs.WEURON_WindowWidth <= 3000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#square1").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=748073"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if(((pbjs.WEURON_WindowWidth >= 0) && (pbjs.WEURON_WindowWidth <= 3000))){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#square2").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=748079"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 1360)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#top-leaderboard-branding").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=748059"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 800)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#scyscraper-levy").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=748086"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 799)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#Interscroller").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=748233"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 799)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        if (hbPlacement) {
            document.querySelector("#adformMobilniBranding").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=748231"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
