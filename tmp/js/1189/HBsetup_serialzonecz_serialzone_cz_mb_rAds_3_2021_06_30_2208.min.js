...
var bidderFloor = {"cpex-tt": 3,"criteo-im": 3,"adform-im-tt": 3,"cpex-nt": 3,"adform-im-nt": 3,"r2b2": 3,"appnexus": 3,"Teads": 3
};
var webFloor = 5.00;
var webResponzivitaRange ='desktop:800::|mobil::799:|individual:0:3000:|vcetneBranding:1360::|bezBrandingu:800:1359:';
var webBidders ='cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,Teads,r2b2_id_2';    
var placementFloor = {"topleaderboarddesktop": 10.00,"topleaderboardmobil": 10.00,"bottomleaderboarddesktop": 10.00,"bottomleaderboardmobil": 10.00,"square1": 10.00,"square2": 10.00,"topleaderboardbranding": 10.00,"scyscraperlevy": 10.00,"Interscroller": 10.00,"leaderboard2desktop": 10.00,"leaderboard2mobil": 10.00,"scyscraperpravy": 10.00,"adformMobilniBranding": 1.00,
};
var bidderAlias = {"cpex-tt":"rubicon","criteo-im":"criteo","adform-im-tt":"adform","cpex-nt":"rubicon","adform-im-nt":"adform","r2b2":"r2b2","appnexus":"appnexus","Teads":"teads"};
var tierAlias = {"748059":"adform_leaderboard","752130":"adform_leaderboardm","748069":"adform_leaderboard3","752121":"adform_leaderboardm3","748073":"adform_square","748079":"adform_square2","748059":"adform_leaderboard","748086":"adform_skyscraper","748233":"adform_interscroller","756109":"adform_leaderboard2","756089":"adform_leaderboardm2","757174":"adform_skyscraper2","748231":"adform_mobilnibranding",
};
var responzivita = {"top-leaderboard-desktop":"bezBrandingu","top-leaderboard-mobil":"mobil","bottom-leaderboard-desktop":"desktop","bottom-leaderboard-mobil":"mobil","square1":"individual","square2":"individual","top-leaderboard-branding":"vcetneBranding","scyscraper-levy":"desktop","Interscroller":"mobil","leaderboard2-desktop":"desktop","leaderboard2-mobil":"mobil","scyscraper-pravy":"desktop","adformMobilniBranding":"mobil",
};    
...
var checkReloadingAdsRestriction;
    checkReloadingAdsRestriction = 3 - (50 - imHbReloadingAds); 
    ...
    checkReloadingAdsRestriction = 3 - (50 - imHbReloadingAds); 
    if (checkReloadingAdsRestriction > 0) {     
        nonResponsiveLeaveBlank = document.querySelector("#leaderboard2-desktop") !== null;
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#leaderboard2-desktop").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 3 - (50 - imHbReloadingAds); 
    if (checkReloadingAdsRestriction > 0) {     
        nonResponsiveLeaveBlank = document.querySelector("#leaderboard2-mobil") !== null;
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#leaderboard2-mobil").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    checkReloadingAdsRestriction = 3 - (50 - imHbReloadingAds); 
    if (checkReloadingAdsRestriction > 0) {     
        nonResponsiveLeaveBlank = document.querySelector("#scyscraper-pravy") !== null;
        if (nonResponsiveLeaveBlank) {
            document.querySelector("#scyscraper-pravy").innerHTML = '<span style="display:none !important">All was removed - All will be set according to the HB administration</span>';
       }
    }
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            ...
            code: 'bottom-leaderboard-desktop',
                mediaTypes: {
                   banner: {sizes: [
               [1010,250],[970,250],[970,210],[970,90],[970,200],[980,200],[1000,200],[1000,250],[970,100],[728,90],[745,100],[745,200],[910,90],[990,250]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            ...
            code: 'top-leaderboard-branding',
                mediaTypes: {
                   banner: {sizes: [
               [2000,1400],[970,250],[970,210],[970,90],[1010,250],[728,90],[970,200],[980,200],[990,250],[1000,200],[1000,250],[745,200],[745,100],[970,100],[910,90]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 800)){
    checkReloadingAdsRestriction = 3 - (50 - imHbReloadingAds);
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#leaderboard2-desktop") !== null;
        if (hbPlacement) {
            document.querySelector("#leaderboard2-desktop").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=756109"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id: 'serialzonecz-1-1189-910391',
            code: 'leaderboard2-desktop',
                mediaTypes: {
                   banner: {sizes: [
               [970,90],[728,90],[468,60],[970,120]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "serialzone/Leaderboard_2_756109",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['leaderboard2-desktop'] = '756109';
  
      }else{
//      var check756109 = document.querySelector("#leaderboard2-desktop") !== null;

//      if (check756109) {
//          document.querySelector("#leaderboard2-desktop").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth <= 799)){
    checkReloadingAdsRestriction = 3 - (50 - imHbReloadingAds);
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#leaderboard2-mobil") !== null;
        if (hbPlacement) {
            document.querySelector("#leaderboard2-mobil").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=756089"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id: 'serialzonecz-1-1189-910392',
            code: 'leaderboard2-mobil',
                mediaTypes: {
                   banner: {sizes: [
               [300,300],[300,250],[300,100]
                   ]}
                },
//          "refresh": 0,
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "serialzone/Leaderboard_2_mobile_756089",    
                        }                
                }
              ]
            }
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['leaderboard2-mobil'] = '756089';
  
      }else{
//      var check756089 = document.querySelector("#leaderboard2-mobil") !== null;

//      if (check756089) {
//          document.querySelector("#leaderboard2-mobil").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
...
// without setting for Web Variable//   URL condition:include#@#regex#@#.*
  ...
  if((pbjs.WEURON_WindowWidth >= 800)){
    checkReloadingAdsRestriction = 3 - (50 - imHbReloadingAds);
    if(checkReloadingAdsRestriction > 0){
        var hbPlacement = document.querySelector("#scyscraper-pravy") !== null;
        if (hbPlacement) {
            document.querySelector("#scyscraper-pravy").innerHTML = '<sc'+'ript data-adfscript="adx.adform.net/adx/?mid=757174"></scr'+'ipt>';            
           }    
        pbjs.adUnits.push(    
        {
            id: 'serialzonecz-1-1189-910393',
            code: 'scyscraper-pravy',
                mediaTypes: {
                   banner: {sizes: [
               [160,600],[120,600]
                   ]}
...
//          "refresh_limit": 0,        
            ...
            "bids": [
                ...
                },
                {
                    ...
                    "bidderCode": "criteo",        
                        "params": {
                               networkId: 7456,
                               publisherSubId: "serialzone/Skyscraper_2_757174",    
                        }                
                },
                {
                    "bidder": "adform-im-tt",
        ...
        if(typeof pbjs.WEURON_MapPositions  === 'undefined'){ 
           pbjs.WEURON_MapPositions  = {}; 
        } pbjs.WEURON_MapPositions ['scyscraper-pravy'] = '757174';
  
      }else{
//      var check757174 = document.querySelector("#scyscraper-pravy") !== null;

//      if (check757174) {
//          document.querySelector("#scyscraper-pravy").innerHTML = '';
//      }
      }
  } //end checkReloadingAdsRestriction
