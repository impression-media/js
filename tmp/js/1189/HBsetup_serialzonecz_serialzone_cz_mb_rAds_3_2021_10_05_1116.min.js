...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank; var remImScript;  
    ...
    if(((pbjs.WEURON_WindowWidth >= 800) && (pbjs.WEURON_WindowWidth <= 1359))){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#top-leaderboard-desktop").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 799)){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#top-leaderboard-mobil").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth >= 800)){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#bottom-leaderboard-desktop").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 799)){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#bottom-leaderboard-mobil").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if(((pbjs.WEURON_WindowWidth >= 0) && (pbjs.WEURON_WindowWidth <= 3000))){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#square1").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if(((pbjs.WEURON_WindowWidth >= 0) && (pbjs.WEURON_WindowWidth <= 3000))){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#square2").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth >= 1360)){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#top-leaderboard-branding").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth >= 800)){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#scyscraper-levy").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 799)){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#Interscroller").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
    ...
    if((pbjs.WEURON_WindowWidth <= 799)){
        ...
        setTimeout(function(){
            ...
            document.querySelector("#adformMobilniBranding").setAttribute('im-min-height', 100);          
        }, 10000);
        }
    }else{ 
