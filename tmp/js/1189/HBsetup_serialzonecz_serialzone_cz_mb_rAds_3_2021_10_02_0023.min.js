...
var checkReloadingAdsRestriction; var nonResponsiveLeaveBlank;
    ...
    if(((pbjs.WEURON_WindowWidth >= 800) && (pbjs.WEURON_WindowWidth <= 1359))){
        ...
        if (responsiveConditionReady) {    
            document.querySelector("#top-leaderboard-desktop").innerHTML = '<span style="display:none !important">Responsive condition is FRUE >> Waiting to result of auction for this placement DIV ID</span><sc'+'ript src="
        }
    }else{ 
...
pbjs.que.push(function() {
    ...
    userSync: {
       ...
       sizeConfig: [{"mediaQuery":'(min-width: 800px)',"labels": ["desktop"]
                ...
                {"mediaQuery":'(min-width: 0px) and (max-width: 3000px)',"labels": ["individual"]
                    }, 
                {"mediaQuery":'(min-width: 1360px)',"labels": ["vcetnebranding"]
                    }, 
