...
var webBidders ='cpex-tt,criteo-im,adform-im-tt,cpex-nt,adform-im-nt,r2b2,appnexus,PubMatic,Teads,adform-omd,stroeerCore,r2b2_id_2';    
var placementFloor = {"adformsquare2": 1.00,"AdTrackGenericInterscrollerDesktop": 1.00,"adformMobilniBranding": 1.00,"adformsquare": 1.00,"adformleaderboard": 1.00,
};
...
var tierAlias = {"938108":"adform_square2","686080":"adform_interscroller","447740":"adform_mobilnibranding","428712":"adform_square","428711":"adform_leaderboard",
};
var responzivita = {"adform_square2":"desktop","AdTrackGenericInterscrollerDesktop":"mobil","adformMobilniBranding":"mobil","adform_square":"desktop","adform_leaderboard":"desktop",
};    
...
//  var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1261&statistics=1&hbmasterscript='+hbmasterscript+browserInfo+'&data='+strData);
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1261-910958',
            code: 'adform_square2',
                mediaTypes: {
                   banner: {sizes: [
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1261-910959',
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth <= 999)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1261-910960',
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1261-910957',
            code: 'adform_square',
                mediaTypes: {
                   banner: {sizes: [
...
//  Web Variableexclude#@##@#
  ...
  if((pbjs.WEURON_WindowWidth >= 1000)){
    ...
    if(checkReloadingAdsRestriction > 0){
        ...
        pbjs.adUnits.push(    
        {
            id: 'wwwin-pocasicz-1-1261-910956',
